...
| 25 septembre 2020 | [Configuration des comptes et des services](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/set-up/accounts-and-services.html?lang=fr) | Article | Le développement de travailleurs Asset compute nécessite l’accès à des comptes et à des services, y compris les services as a Cloud Service, Adobe Developer App Builder et l’espace de stockage dans le cloud fourni par Microsoft ou Amazon. |
...
Voir les [[!DNL Target] notes de mise à jour](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html) pour consulter les informations les plus récentes.
...
Voir les [notes de mise à jour](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) [!DNL Marketo] pour consulter les informations les plus récentes.
