...
| 17 août 2020 | [Correspondance client Google](https://experienceleague.adobe.com/docs/platform-learn/tutorials/rtcdp/integrate-with-google-customer-match.html?lang=fr) | Vidéo | Cette vidéo montre comment les fonctionnalités de correspondance client de Real-Time CDP et Google d’Adobe peuvent aider les marques à interagir avec leurs clients sur les propriétés détenues et exploitées de Google, l’objectif commercial étant d’augmenter leurs campagnes de sensibilisation. |
...
* Correction d’un problème qui empêchait le filtrage de [!UICONTROL Workspace] par la dimension &quot;non spécifié&quot;. (AN-222393)
...
| -----------| ---------- |
| Preroll interactif étendu pour inclure l’inventaire VAST | Tous les emplacements et publicités interactifs de preroll peuvent désormais prendre en charge les inventaires VPAID et VAST. **Remarque :** Si votre Principal indicateur de performance clé est la capacité d’affichage, continuez à créer des emplacements et publicités VPAID et VAST distincts, car les impressions affichables ne sont pas disponibles pour les publicités VAST. |
