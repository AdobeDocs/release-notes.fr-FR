...
* [Interface et services principaux d’Experience Cloud](#ecloud) (Date d’ajout : **26 février 2020**)
...
Voir la section [Génération de plusieurs communications interactives avec l’API de lot](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/generate-multiple-interactive-communication-using-batch-api.html).
