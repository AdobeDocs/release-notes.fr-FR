...
| Contenu | Type de contenu | Description |
| -----------| ---------- | ---------- |
| [Prise en main de Customer Journey Analytics pour les utilisateurs ](https://experienceleague.adobe.com/?lang=fr&recommended=CustomerJourneyAnalytics-U-1-2020.1&amp;lang=fr) | Cours | Dans ce cours, vous apprendrez à utiliser Customer Journey Analytics (CJA) pour analyser des données provenant de nombreuses sources de données différentes. Vous découvrirez les différences entre Adobe Analytics et Customer Journey Analytics, ainsi que la manière dont les données sont traitées dans CJA. Après avoir suivi ce cours, vous devriez être en mesure de créer et de personnaliser des visualisations sur plusieurs canaux pour mieux comprendre vos clients. |
| [Prise en main de Customer Journey Analytics pour les administrateurs](https://experienceleague.adobe.com/?lang=fr&recommended=CustomerJourneyAnalytics-A-1-2020.1&amp;lang=fr) | Cours | Apprenez à configurer et à utiliser [!UICONTROL Journey Orchestration]. Ce cours aborde les concepts clés et les étapes de configuration nécessaires pour permettre l’orchestration d’un parcours. Vous apprendrez à créer, publier, créer des rapports et analyser vos parcours orchestrés. |
| [Prise en main de Customer Journey Analytics pour les ingénieurs des données](https://experienceleague.adobe.com/?lang=fr&recommended=CustomerJourneyAnalytics-D-1-2020.1&amp;lang=fr) | Cours | Ce cours vous permettra d’en savoir plus sur les données entrantes dans Customer Journey Analytics et sur l’incidence de ces données sur les rapports destinés à l’analyste. Ce cours s’appuie sur vos connaissances générales d’Adobe Experience Platform. |
...
| [Mise en œuvre guidée d’Analytics](https://experienceleague.adobe.com/?lang=fr&recommended=Analytics-D-1-2019.1&amp;lang=fr) | Cours | Dans ce cours, vous apprendrez à démarrer la mise en œuvre d’Adobe Analytics, comprendre les concepts d’Analytics, créer un plan et mettre en œuvre Adobe Analytics à l’aide d’Experience Platform Launch. |
| [Principes fondamentaux d’Adobe Analytics pour les dirigeants](https://experienceleague.adobe.com/?lang=fr&recommended=Analytics-L-1-2020.1&amp;lang=fr) | Cours | Dans ce cours, découvrez les principes fondamentaux d’Analytics et la manière dont Analysis Workspace peut changer votre activité. Apprenez à découvrir des informations avec Adobe Sensei, écoutez les témoignages des clients et regardez les temps forts des experts du milieu au Summit 2019. |
| [Prise en main d’Analysis Workspace](https://experienceleague.adobe.com/?lang=fr&recommended=Analytics-U-1-2020.1.workspace&amp;lang=fr) | Cours | Apprenez à prendre en main Analysis Workspace. Créez votre premier projet, apprenez à définir des périodes, à appliquer des segments et à partager et collaborer sur des projets. |
...
| Fonctionnalité | Description |
| -----------| ---------- |  
| [Module externe d’Audience Manager pour IAB TCF v2.0](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/consent-management/aam-iab-plugin.html?lang=fr) | Dans la continuité de l&#39;Adobe axé sur la protection des renseignements personnels dès la conception, nous mettons à niveau le module externe Audience Manager pour IAB TCF vers la version 2.0 du Transparency &amp; Consent Framework (TCF) de l&#39;IAB, à compter du 10 juin 2020. Les clients qui ont mis en œuvre le module externe Audience Manager pour IAB TCF doivent effectuer la mise à niveau vers la version 2.0 d’ici le 15 août 2020 afin de continuer à utiliser cette fonctionnalité. Après le 15 août 2020, la version 1.1 deviendra obsolète et ne sera plus prise en charge. |
...
| Contenu | Type de contenu | Description |
| -----------| ---------- | ---------- |  
| [Présentation d’Audience Manager](https://experienceleague.adobe.com/?lang=fr&recommended=AudienceManager-U-1-2020.1&amp;lang=fr) | Cours | Ce cours vous apprend les concepts de base d’Audience Manager et vous présente les problèmes qu’il peut vous permettre de résoudre. Découvrez les cas d’utilisation courants, les termes et les concepts clés d’Audience Manager. |
...
* **AEM as a Cloud Service**
   ...
   * Les nouvelles améliorations du libre-service réduisent les dépendances d’Adobe pour les opérations sur les sandbox.
      ...
      * Les environnements à hibernation automatique des sandbox les font entrer automatiquement « en hibernation » après une période d’inactivité. Les clients peuvent déclencher eux-mêmes la « sortie d’hibernation ».
...
| Contenu | Type de contenu | Description |
| -----------| ---------- | ---------- |  
| [Prise en main d’Adobe Campaign Standard pour les utilisateurs professionnels](https://experienceleague.adobe.com/?lang=fr&recommended=Campaign-U-1-2020.1.standard&amp;lang=fr) | Cours | Apprenez à naviguer dans l’interface, travailler avec des distributions ainsi que créer et gérer des données de destinataires. |
| [Installation et configuration du client Adobe Campaign](https://experienceleague.adobe.com/?lang=fr&recommended=Campaign-U-1-2020.1.standard&amp;lang=fr) | Vidéo | Apprenez à télécharger et installer la console du client Adobe Campaign, à créer et gérer vos connexions à plusieurs environnements et à vérifier l’accès à la console du client Adobe Campaign |
