...
* **Espace de travail de science des données :** le [!DNL JupyterLab Launcher] inclut désormais un notebook [!DNL Python] de démarrage pour l’apprentissage automatique en temps réel (Alpha).
...
* **AEM as a Cloud Service**
   ...
   * Les nouvelles améliorations du libre-service réduisent les dépendances d’Adobe pour les opérations sur les sandbox.
      * L’amélioration de la prise en charge de la sandbox en libre-service dans Cloud Manager permet aux utilisateurs autorisés de supprimer tous les environnements au sein d’une sandbox et de recevoir des crédits.
