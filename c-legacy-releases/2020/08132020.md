...
* **Composants principaux**
  ...
  La version 2.11.0 des composants principaux introduit la prise en charge d’AMP et est maintenant disponible avec la [documentation sur la création](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=fr) de même que les [détails du développeur et le téléchargement de projet disponibles sur GitHub.](https://github.com/adobe/aem-core-wcm-components)
