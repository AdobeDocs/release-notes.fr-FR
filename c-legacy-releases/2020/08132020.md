...
>[!NOTE]
>
>Inscrivez-vous aux [Mises à jour produit prioritaires d’Adobe](https://www.adobe.com/subscription/priority-product-update.html?lang=fr) afin de recevoir une notification par courrier électronique concernant les prochaines mises à jour.
...
| 21 juillet 2020 | [Projets de traduction](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html?lang=fr) | Tutoriel | Découvrez comment créer, modifier et gérer un projet de traduction pour votre [!UICONTROL copie de la langue]. |
...
| 21 juillet 2020 | [Mettre à jour la copie de la langue avec les lancements](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/updating-language-copy.html?lang=fr) | Tutoriel | Découvrez comment mettre à jour, réviser et approuver les modifications dans une [!UICONTROL copie de la langue] à l’aide des lancements. |
| 21 juillet 2020 | [Présentation de la gestion multisite](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/language-copy-overview.html?lang=fr) | Tutoriel | Profitez d’une présentation sur la création d’un site multilingue à l’aide de [!UICONTROL Copie de la langue] dans [!UICONTROL AEM Sites]. |
...
| 21 juillet 2020 | [Créer une copie de la langue](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/manage-component-inheritance-live-copy.html?lang=fr) | Tutoriel | Description |
...
| 21 juillet 2020 | [Présentation de l’éditeur d’application d’une seule page (SPA)](https://video.tv.adobe.com/v/3410040?quality=12&learn=on&captions=fre_fr) | Tutoriel | Présentation du cours Prise en main de l’éditeur d’application d’une seule page AEM pour les développeurs. |
