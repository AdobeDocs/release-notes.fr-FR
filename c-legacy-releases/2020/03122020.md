...
* [!DNL Target] – L’ID de session [!DNL Target] sera désormais ajouté comme paramètre de données contextuelles « a.target.sessionId » dans l’accès [!UICONTROL Analytics-for-Target] interne envoyé à Adobe Analytics.
