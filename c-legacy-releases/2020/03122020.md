...
## ![Icône](/assets/ec_appicon_24.png) Interface et services principaux d’Experience Cloud {#ecloud}
...
* [!DNL Target] - [!DNL Target] L’ID de session sera désormais ajouté en tant que paramètre de données contextuelles &quot;a.target.sessionId&quot; dans l’accès interne [!UICONTROL Analytics-for-Target] envoyé à Adobe Analytics.
...
* Correction d’un problème en raison duquel les mesures d’entrée ou de sortie étaient parfois incorrectement comptabilisées lorsqu’elles étaient appliquées à &quot;Non spécifié&quot; dans un rapport de dimension classifiée.
...
Voir [AppMeasurement pour les notes de mise à jour de JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=fr). La version 2.20.0 a été publiée le 5 mars 2020.
