...
| [Navigation](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/navigation.html) | Explorez les bases de la navigation dans AEM Assets. |
...
Pour en savoir plus, consultez les [notes de mise à jour](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) de [!DNL Marketo].
