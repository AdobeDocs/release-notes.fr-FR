...
| Juin 2021 | [Copie de schémas entre des sandbox](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/copy-schemas-between-sandboxes.html?lang=fr) | Vidéo | Découvrez comment copier un schéma d’une sandbox vers un autre dans Adobe Experience Platform à l’aide de l’[!UICONTROL API Export/Import Schema]. Créez et testez vos schémas dans les sandbox, puis copiez-les vers les environnements de production. |
