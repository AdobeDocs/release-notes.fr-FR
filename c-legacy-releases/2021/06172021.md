...
* Aide dʼadministration pour les [Composants de lʼinterface centrale](https://experienceleague.adobe.com/?lang=frdocs/core-services/interface/experience-cloud.html) et la gestion des utilisateurs
...
| Fonctionnalité | Description |
| ------- | ----------- |
| [!UICONTROL Opérations] | (Campagnes Google Ads) [!UICONTROL Advertising Cloud Search] synchronise, optimise et fournit désormais l’attribution pour les annonces d’inventaire local dans les campagnes d’achats.<br><br>Configurez et gérez vos annonces d’inventaire local dans Google Ads. |
