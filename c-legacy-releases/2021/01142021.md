...
| -----------| ---------- | ---------- | ---------- |
| 23 décembre 2020 | [Présentation des schémas d’union](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/union-schemas-overview.html?lang=fr) | Vidéo | Découvrez les schémas d’union utilisés par Real-time Customer Profile d’Adobe Experience Platform. |
...
| Publié | Nom | Solution | Description |
| ----------- | ----------- | ---------- | ---------- |
| 14 novembre 2020 | [Créer des tableaux de bord Advertising avec Adobe Analytics](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-dashboards-a4adc.html) | Vidéo | Techniques de création d’un tableau de bord Advertising pour la surveillance des campagnes en direct. |
