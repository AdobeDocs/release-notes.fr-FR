...
| Novembre 2021 | [Utilisation des API SOAP dans les workflows](https://experienceleague.adobe.com/docs/campaign-learn/use-soap-apis/introduction.html) | Tutoriels vidéo | Découvrez comment utiliser les API Adobe Campaign Soap et créer un workflow de diffusion avancé en fonction des données reçues via lʼAPI. | Campaign V8 |
