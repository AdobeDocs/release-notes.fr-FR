...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Avril 2021 | [Comprendre Real-time CDP pour les utilisateurs Audience Manager](https://experienceleague.adobe.com/?lang=fr&recommended=AudienceManager-U-1-2020.1.rtcdp&amp;lang=fr) | Cours | Les clients Audience Manager repensent leur gestion de contenu en passant à Adobe Real-time Customer Data Platform (Real-time CDP). Ce cours adopte une approche concept par concept, aidant les utilisateurs Audience Manager à comprendre comment ces concepts sont traités dans Real-time CDP. |
