...
| Avril 2021 | [Contrôle de votre expérience PDF en ligne et regroupement des analyses](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfembed/controlpdfexperience.html?lang=fr) | Article | Votre organisation publie-t-elle des fichiers PDF sur votre site web ? Découvrez comment utiliser l’API intégrée d’Adobe PDF pour contrôler l’apparence, activer la collaboration et collecter des analyses sur la manière dont l’utilisateur interagit avec les PDF, y compris le temps passé sur une page et les recherches. |
