...
Comme indiqué dans les notes de mise à jour de mai (2022.5.0), l’option « Ajouter une arborescence » sous l’onglet Distribuer de l’écran d’administration de l’agent de réplication a été supprimée. Les packages avec une arborescence de contenu doivent plutôt être répliqués à l’aide de Gérer la publication ou du flux Publier l’arborescence de contenu.
...
* [Mise à jour de juin du Panneau de Contrôle](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html)
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Août 2022 | [Tutoriels Workfront](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/home.html) | Tutoriels - accueil | Consultez la nouvelle page d’accueil des tutoriels Workfront sur Experience League. |
...
| Fonctionnalité | Description |
| ------- | ----------- |
| [!UICONTROL Opérations] | (Fonctionnalité d’accès à la version Beta pour tous les annonceurs, mise à jour du 16 juillet) Vous pouvez désormais créer et gérer des campagnes [!DNL Google Ads] de type « Performances max », y compris la création manuelle de groupes de ressources et le téléchargement de ressources. Les liens vers les flux de produit [!DNL Google Merchant Center] ne sont pas pris en charge.<br><br>Une fois que vous avez rejoint la version Beta, vous pouvez créer des campagnes avec le [!UICONTROL Type de campagne] « [!UICONTROL Performances Max] » et configurer des groupes de ressources dans les paramètres de la campagne. Vous pouvez également afficher vos campagnes « Performances max » existantes, avec des données de performances au format tableau et graphique de tendances, dans la vue [!UICONTROL Campagnes]. Les données de performances au niveau des campagnes sont également disponibles dans les rapports ainsi que dans Adobe Analytics (pour les annonceurs qui disposent d’une intégration [!DNL Analytics]).<br><br>Pour rejoindre la version Beta, contactez votre équipe de compte [!DNL Adobe]. |
