...
* Pour obtenir des informations sur la version préliminaire d’Adobe Target, voir les notes de mise à jour de la [Version préliminaire d’Adobe Target](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html).
* Pour obtenir des informations à jour, voir les [Notes de mise à jour d’Adobe Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html).
