...
## Guides du Experience Manager {#xml-doc}
...
* Pour obtenir des informations sur la version actuelle, voir [Notes de mise à jour de Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html?lang=fr).
