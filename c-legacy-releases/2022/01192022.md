...
* **Experience Manager as a Cloud Service**
   ...
   * **Cloud Manager**
      ...
      * L’en-tête de réponse `x-request-id` est désormais visible dans l’API Playground sur [www.adobe.io](https://www.adobe.io/). Cet en-tête est utile lors de l’envoi de problèmes d’assistance clientèle à des fins de dépannage.
