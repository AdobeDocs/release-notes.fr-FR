...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Juin 2022 | [texte du lien](https://experienceleague.adobe.com/?lang=fr&recommended=Target-D-1-2021.1&amp;lang=fr) | Cours | Découvrez comment implémenter Adobe Target sur votre site web. Le cours commence par des sujets administratifs, notamment les exigences et les autorisations utilisateur. Il aborde ensuite les méthodes d’implémentation, les considérations et les bonnes pratiques. |
