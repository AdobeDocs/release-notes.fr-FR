...
| [!DNL Inventory Inspector] | (Version du 29 juin) L’onglet [!UICONTROL Inventaire] de l’emplacement [!UICONTROL Inspecteur] comprend désormais des graphiques de visualisation de données personnalisables et des mesures de performances étendues, telles que le [!UICONTROL Taux de visibilité], les [!UICONTROL Clics], et le [!UICONTROL CPM du jour précédent]. |
