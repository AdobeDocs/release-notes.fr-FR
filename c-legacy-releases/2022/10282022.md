...
* [Notes de mise à jour des Recommendations de produits](https://experienceleague.adobe.com/docs/commerce-merchant-services/product-recommendations/release-notes.html?lang=fr)
...
|  | (Fonctionnalité Beta pour les comptes [!DNL Microsoft Advertising]) Vous pouvez désormais créer et gérer des annonces multimédias dans des campagnes de recherche, à partir de la vue [!UICONTROL Campagnes] et en utilisant des feuilles d’envoi groupé. Le type de contenu créatif de ces annonces est « [!UICONTROL Annonce multimédias] ».<br><br>Vous pouvez inclure des campagnes avec des annonces multimédias dans les portfolios standard ou hybrides avec n’importe quelle stratégie de dépenses, à l’exception de [!UICONTROL Taux d’impressions cible] (qui n’est pas encore pris en charge dans les portfolios hybrides).<br><br>Vous pouvez également afficher vos campagnes d’audience existantes, avec des données de performances au format tableau et graphique de tendances, dans la vue [!UICONTROL Campagnes]. Les données de performances au niveau des campagnes sont également disponibles dans les rapports ainsi que dans [!DNL Analytics] (pour les annonceurs qui disposent d’une intégration [!DNL Analytics]). |
| [!UICONTROL Campagnes], [!UICONTROL rapports] | (Fonctionnalité Beta pour les comptes [!DNL Google Ads] et [!DNL Microsoft Advertising]) Les mesures de taux d’impressions de l’éditeur sont désormais disponibles sous forme de colonnes dans les vues et rapports de gestion de campagnes suivants :<ul><li>Vues de gestion de campagnes : toutes les vues d’entité de campagnes, à l’exception de la vue [!UICONTROL Annonces]. <b>Remarque :</b> les données relatives aux annonces ne sont pas disponibles auprès des réseaux publicitaires.</li><li>Rapports de base : tous les rapports, à l’exception des rapports sur les [!UICONTROL Variantes des annonces], la [!UICONTROL campagne quotidienne] et les [!UICONTROL Contraintes de réseau]. <b>Remarque :</b> les données relatives aux annonces ne sont pas disponibles à partir des réseaux publicitaires.</li><li>Rapports spécialisés : [!UICONTROL Cibles d’audience AdWords et Bing], [!UICONTROL Taux d’impressions quotidien de la campagne] et [!UICONTROL Taux d’impressions quotidien des mots-clés].</li></ul><b>Remarque :</b> les rapports [!UICONTROL Taux d’impressions quotidien de la campagne] et [!UICONTROL Taux d’impression quotidien des mots-clés] sont devenus redondants. Ils seront donc supprimés dans une version ultérieure. Si vous utilisez ces types de rapports pour les rapports planifiés, les modèles ou les flux de feuilles de calcul, passez plutôt aux rapports [!UICONTROL Campagne] et [!UICONTROL Mot-clé]. En attendant, certaines mesures existantes sont dupliquées dans ces types de rapports. |
| [!UICONTROL Règles de valeur de conversion] | ([!DNL Google Ads accounts]) La vue [!UICONTROL Règles de valeur de conversion] n’est plus en version Beta et est disponible pour tous les utilisateurs. Utilisez-la pour afficher vos règles de valeur de conversion [!DNL Google Ads]. Les annonceurs avec le suivi des conversions [!DNL Google Ads] au niveau du compte individuel ou inférieur peuvent également créer et gérer des règles. |
| [!UICONTROL Advertising Insights] | Les analyses [!UICONTROL Perte du taux d’impression] et [!UICONTROL Query Cross Matching] ne sont plus en version Beta et sont disponibles pour tous les utilisateurs. |
| [!UICONTROL Recommendations] | (Comptes [!DNL Google Ads] uniquement) La fonctionnalité [!UICONTROL Recommendations] n’est plus en version Beta et est disponible pour tous les utilisateurs.<ul><li>Affichez en un coup d’œil toutes les recommandations [!DNL Google Ads] qui n’ont pas été appliquées pour un compte.</li><li>Appliquer et ignorer les recommandations pour un compte.</li><li>Afficher les journaux de chaque recommandation appliquée pour un compte.</li></ul> |
| [!UICONTROL Importer des campagnes] | (Fonctionnalité Beta) Vous pouvez importer vos campagnes [!DNL Google Ads] de type Performance Max, y compris les annonces d’inventaire local, dans les campagnes d’achats intelligents [!DNL Microsoft Advertising] à partir du menu [!UICONTROL Outils] > [!UICONTROL Importer des campagnes]. Une fois que vous avez importé des campagnes, vous pouvez vérifier le statut de votre tâche d’importation, consulter les journaux d’erreur et modifier, suspendre ou supprimer votre planning d’importation. |
