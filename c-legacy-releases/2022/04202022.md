...
* [Recherche unifiée dʼobjets et dʼentités](https://experienceleague.adobe.com/docs/core-services/interface/services/search-experience-cloud.html)
...
| Avril 2022 | [Les segments rapides dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/quick-segments-in-analysis-workspace.html) | Vidéo | Les _segments rapides_ sont une expérience de segmentation simplifiée qui s’effectue directement dans la zone de l’[!UICONTROL espace de travail]. Découvrez comment créer des segments à la volée contenant jusqu’à trois règles sans avoir à quitter votre flux d’analyses. |
...
* [notes de mise à jour](https://experienceleague.adobe.com/docs/media-analytics/using/additional-resources/release-notes.html?lang=fr) de [!DNL Streaming Media Analytics] (**nouvel emplacement**)
...
| Avril 2022 | [Assembler des PDF en invoquant l’opération DDX](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-cs-assembler/introduction.html) | Vidéo | Repository Browser est un outil puissant qui offre une visibilité sur le magasin de données sous-jacentes d’AEM, permettant ainsi un débogage simple de l’environnement AEM as a Cloud Service. Repository Browser prend en charge l’inspection de toutes les ressources et propriétés d’AEM pendant la production, l’évaluation et le développement, ainsi que les services Créer, Publier et Prévisualiser. | AEM CS |
...
| Avril 2022 | [Déboguer AEM as a Cloud Service avec Repository Browser](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/repository-browser.html?lang=fr) | Vidéo | Découvrez l’Explorateur de référentiels, un outil puissant qui offre une visibilité sur le magasin de données sous-jacentes d’AEM, permettant ainsi un débogage simple de l’environnement AEM as a Cloud Service. | AEM CS |
...
* [Page dʼaccueil de formation et de support pour Experience Manager 6.2](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html#previous-updates)
...
* Pour obtenir des informations sur la version préliminaire, consultez la section [Version préliminaire d’Adobe Target](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html).
* Pour obtenir des informations à jour, consultez la page [Notes de mise à jour d’Adobe Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html).
...
| [!UICONTROL Advertising Insights] | Tous les informations, à l’exception de [!UICONTROL Query Cross Matching] et [!UICONTROL Hybrid Portfolio Setup Readiness] sont désormais obsolètes. |
