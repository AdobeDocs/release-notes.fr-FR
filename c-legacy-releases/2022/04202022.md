...
* [notes de mise à jour[!DNL Streaming Media Analytics] de ](https://experienceleague.adobe.com/docs/media-analytics/using/additional-resources/release-notes.html?lang=fr) (**nouvel emplacement**)
...
| [!UICONTROL Insights publicitaires] | Tous les insights, à l’exception de [!UICONTROL Query Cross Matching] et [!UICONTROL Hybrid Portfolio Setup Readiness] sont désormais obsolètes. |
