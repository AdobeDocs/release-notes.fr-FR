...
| Intégration avec Adobe Analytics | (7 avril) Dans le flux de données qu’Advertising Cloud envoie à [!DNL Analytics], les données pour les annonces (RSA) [!DNL Google Ads] et [!DNL Microsoft Advertising] sont désormais classées avec le [!UICONTROL type d’annonce] « [!UICONTROL Annonces de recherche responsives] » lorsqu’elles reçoivent de nouveaux clics. Auparavant les données étaient incluses pour le [!UICONTROL type d’annonce] « [!UICONTROL Annonces de texte] ». Les annonces de recherche responsives dans les campagnes inactives ne seront pas reclassées.<br><br>Pour les annonces de recherche responsives, le [!UICONTROL titre des annonces responsives] est désormais rempli par le premier titre et la [!UICONTROL description de l’annonce responsive] est remplie par la première description. |
