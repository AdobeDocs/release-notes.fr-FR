...
| Avril 2022 | [Traduire le langage technique Adobe Analytics en langage adapté à tous](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/translating-adobe-analytics-technical-language.html?lang=fr#) | Vidéo | En tant qu’expert Adobe Analytics de votre entreprise, vous êtes essentiel pour aider vos parties prenantes à comprendre les détails techniques et tirer le meilleur parti de votre investissement Adobe Analytics. |
...
| Avril 2022 | [Expérience Détails des connexions dans CJA](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections-details-experience-in-cja.html?lang=fr) | Vidéo | Découvrez comment vérifier l’état des jeux de données de votre connexion et du processus d’ingestion. |
...
| Avril 2022 | [Déboguer AEM as a Cloud Service avec Repository Browser](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/repository-browser.html?lang=fr) | Vidéo | Découvrez Repository Browser, un outil puissant qui offre une visibilité sur AEM entrepôt de données sous-jacent, ce qui permet de déboguer facilement AEM environnement as a Cloud Service. | AEM CS |
...
| Intégration avec Adobe Analytics | (7 avril) Dans le flux de données qu’Advertising Cloud envoie à [!DNL Analytics], les données pour les annonces (RSA) [!DNL Google Ads] et [!DNL Microsoft Advertising] sont désormais classées avec le [!UICONTROL type d’annonce] « [!UICONTROL Annonces de recherche responsives] » lorsqu’elles reçoivent de nouveaux clics. Auparavant les données étaient incluses pour le [!UICONTROL type d’annonce] « [!UICONTROL Annonces de texte] ». Les RSA dans les campagnes inactives ne seront pas reclassés.<br><br>Pour les annonces de recherche responsives, le [!UICONTROL titre des annonces responsives] est désormais rempli par le premier titre et la [!UICONTROL description de l’annonce responsive] est remplie par la première description. |
