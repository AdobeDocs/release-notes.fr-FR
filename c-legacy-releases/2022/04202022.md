...
| ------| ----- | ------ | ------ |-----|
| Avril 2022 | [Génération de documents à l’aide de l’API de communication](https://experienceleague.adobe.com/?lang=fr&recommended=ExperienceManager-D-1-2022.3.formscs&amp;lang=fr) | Cours | Fusionner les données avec un modèle xdp en invoquant les terminaux HTTP du service de conversion des formulaires. | AEM Forms |
