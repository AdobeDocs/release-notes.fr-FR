...
| Mai 2022 | [Analyse et visualisation des informations omnicanal dans Tableau à l’aide de Query Service](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/analyze-and-visualize.html?lang=fr) | Vidéo | Découvrez comment utiliser Adobe Experience Platform Query Service avec des outils de visualisation de données externes à l’aide d’un exemple d’analyse de perte de clientèle. | Experience Platform |
...
| Intégration à Adobe Analytics | (7 avril) Dans le flux de données envoyé par Advertising Cloud à [!DNL Analytics], les données pour les annonces de recherche dynamique [!DNL Google Ads] ne sont disponibles qu’au niveau du groupe d’annonces à compter du 7 mai 2022. |
