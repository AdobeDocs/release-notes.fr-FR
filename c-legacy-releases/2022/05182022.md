...
| ------- | ----------- |
| [!UICONTROL Rapports personnalisés] | (31 mai); (fonctionnalité bêta) Advertising Cloud DSP peut désormais ingérer des segments propriétaires composés de signaux authentifiés créés dans une plateforme de données client (CDP). |
| Objectifs d’optimisation | (25 mai) Des vidéos et des emplacements natifs peuvent désormais être inclus dans des modules avec des objectifs personnalisés. [!UICONTROL RSDP le plus élevé] et [!UICONTROL CPA la plus basse]. |
...
| Intégration à Adobe Analytics | (7 mai) Dans le flux de données envoyé par Advertising Cloud à [!DNL Analytics], données pour [!DNL Google Ads] les annonces de recherche dynamique ne sont disponibles qu’au niveau du groupe d’annonces à compter du 7 mai 2022. |
