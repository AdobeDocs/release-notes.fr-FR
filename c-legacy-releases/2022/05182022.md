...
| Intégration à Adobe Analytics | (7 mai) Dans le flux de données envoyé par Advertising Cloud à [!DNL Analytics], les données pour les annonces de recherche dynamique [!DNL Google Ads] ne sont disponibles qu’au niveau du groupe publicitaire à compter du 7 mai 2022. |
