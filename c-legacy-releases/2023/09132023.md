...
| Septembre 2023 | AEM Forms | [Enregistrer la valeur des variables dans le workflow AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/variables-aem-workflow/part6.html) | Article | Consignez la valeur des variables de workflow AEM. Les développeurs et développeuses peuvent suivre et comprendre comment un workflow AEM s’exécute, diagnostiquer les problèmes et surveiller le flux de données dans un workflow AEM. |
