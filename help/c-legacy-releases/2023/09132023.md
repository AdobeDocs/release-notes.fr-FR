...
* Experience Manager Assets comprend désormais une nouvelle version 9 de l’index `damAssetLucene`. `damAssetLucene-9` modifie le comportement du comptage des facettes de requête d’Oak afin de [ne plus évaluer le contrôle d’accès sur les nombres de facettes](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/search-assets.html?lang=fr) renvoyés par l’index de recherche sous-jacent, ce qui accélère les temps de réponse de la recherche.
...
* Lors de la configuration d’un ensemble de contenu pour [copier du contenu, les configurations basées sur le contexte](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/configurations.html?lang=fr) sont désormais autorisées dans les ensembles de contenu de l’interface d’utilisation.
...
* [Utilisateurs AEM - Partagez vos commentaires sur Gartner Peer Insights !](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-experience-manager-users-share-your-feedback-on-gartner/td-p/613702?profile.language=fr)
...
* [Notes de mise à jour du pack de services 6.5 d’Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/release-notes.html?lang=fr)
