---
title: Notes de mise à jour centrales - Février 2023
...
Voir [Événements Experience League](https://experienceleague.adobe.com/events?lang=fr/) pour un planning complet.
...
* Les notifications de Status sont désormais disponibles sur [!DNL Slack]. En une seule configuration, vous pouvez ajouter l’application [!DNL Adobe Status Slack] à votre espace de travail [!DNL Slack] et recevoir des notifications de Status dans votre canal [!DNL Slack]. Veuillez utiliser ce lien pour gérer vos préférences d’abonnement : [https://status.adobe.com/fr-fr/proactive-notifications/manage](https://status.adobe.com/fr/proactive-notifications/manage).
...
<!-- For the latest release information, see Adobe System Status [release notes](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html?lang=fr#status). -->
...
| -----------| ---------- | ---------- | ---------- |
|January 2023|[Schedule Customer Journey Analytics workbooks using Report Builder](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/exporting/report-builder/schedule-cja-workbooks-using-report-builder.html?lang=fr)|Video |Learn how to schedule workbooks in Report Builder for Customer Journey Analytics. Scheduling workbooks lets users automate the process of refreshing Report Builder workbooks with the latest data and sending it to stakeholders on a regular, pre-defined schedule.|
|January 2023|[Leverage date field support](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/use-cases/data-views-use-cases/leverage-date-field-support.html?lang=fr)|Video |You can use date and date-time fields within Customer Journey Analytics. Select how the date or date-time field is displayed, and use date-specific logical operators in the include/exclude functionality to filter what is displayed.|
|January 2023|[First-time and returning sessions](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/use-cases/data-views-use-cases/first-time-and-returning-sessions.html?lang=fr)|Video |Learn how to distinguish between first-time and returning sessions for your users. This is accomplished through a 13-month look-back applied to your report.|
|January 2023|[Use the experimentation panel](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/panels/use-the-experimentation-panel.html?lang=fr)|Video |Learn how to configure and use the experimentation panel, which automatically builds some visualizations based on your experiment data.|
...
>[!IMPORTANT]
>
>Adobe vous recommande d’[effectuer une mise à niveau vers la dernière version 1.9.6](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=fr) du connecteur amélioré [!DNL Workfront] for Experience Manager.

### Communauté

* **Webinaire Experience Manager GEMS à venir :** _Accélérer le développement d’Experience Manager as a Cloud Service avec des environnements de développement rapide_. [Inscrivez-vous ici](https://bit.ly/3x1Cl8x).
...
* **Community Lens de Adobe Experience Manager :** met en avant les dernières mises à jour de la communauté Experience Manager, en un seul endroit. [Lisez la 4ème édition maintenant](https://bit.ly/3CAxuy2).
...
| Fonctionnalité | Description |
| ------- | ----------- |
| [!UICONTROL Campagnes] | (Version du 3 février ; fonctionnalités beta) Vous pouvez désormais afficher les journaux des modifications sous forme de graphique et ajouter des notes à n’importe quelle entrée. |
