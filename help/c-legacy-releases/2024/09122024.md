---
title: Notes De Mise À Jour Centrales - Septembre À Octobre 2024
...
Publication : **mardi 19 août 2024**
...
| Octobre 2 | Accueil personnalisable | Sur la page de destination d’Experience Cloud, cliquez sur **[!UICONTROL Modifier]**. [!UICONTROL Le mode Modifier] vous permet de personnaliser votre page d’accueil Experience Cloud avec un accès à une bibliothèque de widgets et à des arrière-plans personnalisés. [!UICONTROL Le mode Modifier] fournit des commandes intuitives et transparentes pour le déplacement, le redimensionnement et la gestion des widgets, y compris des actions en masse et des réglages de disposition, pour une expérience plus esthétique et personnalisée. Personnalisez votre page d’accueil Experience Cloud avec un accès à une bibliothèque de widgets et à des arrière-plans personnalisés. |
...
| Septembre 2024 | AEM Forms | [Présentation des images cliquables](https://experienceleague.adobe.com/fr/docs/experience-manager-learn/cloud-service/forms/clickable-image-component/introduction) | Vidéo | Créez des composants d’image cliquables dans AEM Forms Cloud Service. |
...
| Publié | Nom | Type | Description |
|---------|--------|---------|---------|
| Août 2024 | [Les références CF dans les [!UICONTROL fragments de contenu] ne sont pas ajustées en fonction de la copie linguistique](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-24819). | Nouvel article | Découvrez comment résoudre le problème lorsque les références dans les [!UICONTROL fragments de contenu] ne sont pas mises à jour en fonction de la [!UICONTROL copie linguistique] dans [!DNL AEM]. |
