---
title: Notes de mise à jour centrales - Mai 2024
...
|Published|Name|Type|Description |
| -----------| ---------- | ---------- | ---------- |
|April 2024|[Add forecasting to your visualization](https://experienceleague.adobe.com/fr/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/forecasting)|Video |Learn how to add forecasting numbers to your time series visualization in Customer Journey Analytics.|
...
|March 2024|[Add forecasting to your visualization](https://experienceleague.adobe.com/fr/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/forecasting)|Video |Learn how to add forecasting numbers to your time series visualization in Customer Journey Analytics.|
...
| Mai 2024 | [!DNL AEM Sites] | [Générer des variations - Modèles de prompts dans Edge Delivery Services](https://experienceleague.adobe.com/fr/docs/experience-manager-learn/sites/document-authoring/how-to/generate-variations/prompt-templates) | Vidéo | Découvrez comment utiliser les modèles de prompt par IA générative dans la création de documents Edge Delivery Services pour générer des variations de contenu. |
| Mai 2024 | [!DNL AEM Sites] | [Générer des variations - Modèles de prompts personnalisés dans Edge Delivery Services](https://experienceleague.adobe.com/fr/docs/experience-manager-learn/sites/document-authoring/how-to/generate-variations/custom-prompt-templates) | Vidéo | Découvrez comment créer des modèles de prompts personnalisés pour générer des variations dans la création de documents Edge Delivery Services. |
| Mai 2024 | [!DNL AEM Sites] | [Générer des variations - Enregistrer des modèles de prompts personnalisés dans Edge Delivery Services](https://experienceleague.adobe.com/fr/docs/experience-manager-learn/sites/document-authoring/how-to/generate-variations/save-custom-prompt-template) | Vidéo | Découvrez comment enregistrer les modèles de prompts personnalisés d’IA générative dans la création de documents Edge Delivery Services pour générer des variations de contenu. |
