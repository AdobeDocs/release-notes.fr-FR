---
title: Notes de mise à jour centrales - Janvier 2024
...
Affichez tous les [événements à venir](https://experienceleague.adobe.com/fr/events) ou parcourez les [enregistrements d’événement](https://experienceleague.adobe.com/fr/docs/events/experience-league-recorded-events/overview) sur Experience League.
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Décembre 2023 | SDK Mobile | [Tutoriel sur l’implémentation d’Adobe Experience Cloud dans les applications mobiles](https://experienceleague.adobe.com/fr/docs/platform-learn/implement-mobile-sdk/overview) | Tutoriel mis à jour (plusieurs articles) | Découvrez comment implémenter les applications Adobe [!DNL Experience Cloud] dans votre application mobile à l’aide d’Adobe [!DNL Experience Platform Mobile SDK]. |
| Décembre 2023 | Platform, Journey Optimizer | [Créer et envoyer des notifications push](https://experienceleague.adobe.com/fr/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-push) | Article | Découvrez comment créer des notifications push pour les applications mobiles avec [!DNL Experience Platform Mobile SDK] et [!DNL Journey Optimizer]. |
| Décembre 2023 | SDK mobile, Journey Optimizer | [Créer et envoyer des messages in-app](https://experienceleague.adobe.com/fr/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp) | Article | Découvrez comment créer des messages in-app pour les applications mobiles avec [!DNL Experience Platform Mobile SDK] et [!DNL Journey Optimizer]. |
| Décembre 2023 | Platform, Journey Optimizer | [Créer et afficher des offres avec la gestion des décisions](https://experienceleague.adobe.com/fr/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers) | Article | Découvrez comment afficher les offres à partir de la [!UICONTROL gestion des décisions] [!DNL Journey Optimizer] dans vos applications mobiles avec [!DNL Experience Platform Mobile SDK]. |
| Décembre 2023 | Administration | [Ajouter des administrateurs et administratrices de produit](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/admin/add-product-administrators) | Vidéo | Découvrez comment ajouter de nouveaux administrateurs et de nouvelles administratrices pour Adobe [!DNL Experience Platform] dans [!DNL Admin Console]. Les administrateurs et administratrices peuvent ajouter et gérer des administrateurs et admnistratrices, des utilisateurs et utilisatrices, des membres de l’équipe de développement, et des informations d’identification d’API supplémentaires. |
| Décembre 2023 | Administration | [Ajouter des membres à l’équipe de développement et attribuer des autorisations aux informations d’identification d’API](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/admin/add-developers) | Vidéo | Découvrez comment ajouter des membres de l’équipe de développement à des applications Adobe Experience Platform telles que [!DNL Real-Time Customer Data Platform] et [!DNL Journey Optimizer]. |
| Décembre 2023 | Administration | [Ajouter des utilisateurs et utilisatrices, et gérer des autorisations](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/admin/add-users) | Vidéo mise à jour | Découvrez comment ajouter des utilisateurs et des utilisatrices, et gérer des autorisations dans des applications Adobe Experience Platform telles que [!DNL Real-Time Customer Data Platform] et [!DNL Journey Optimizer]. |
| Décembre 2023 | Collecte de données | [Créer un train de données](https://experienceleague.adobe.com/fr/docs/platform-learn/implement-mobile-sdk/initial-configuration/create-datastream) | Vidéo | Découvrez comment créer un train de données dans Experience Platform. |
| Décembre 2023 | Collecte de données | [Créer une propriété de balise](https://experienceleague.adobe.com/fr/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags) | Vidéo | Découvrez comment configurer une propriété de balise dans l’interface [!UICONTROL Collecte de données]. |
| Décembre 2023 | Collecte de données | [Installer les SDK mobiles Adobe Experience Platform](https://experienceleague.adobe.com/fr/docs/platform-learn/implement-mobile-sdk/app-implementation/install-sdks) | Articles | Découvrez comment implémenter [!DNL Experience Platform Mobile SDK] Adobe dans une application mobile. |
| Décembre 2023 | Profils | [Créer un attribut calculé pour la somme des achats](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/profiles/create-a-computed-attribute-for-sum-of-purchases) | Vidéo | Découvrez comment utiliser des attributs calculés pour additionner les montants d’achat effectués par un utilisateur ou une utilisatrice sur plusieurs canaux de vente. |
| Décembre 2023 | Collecte de données | [Créer une propriété de balises](https://experienceleague.adobe.com/fr/docs/platform-learn/data-collection/tags/create-a-property) | Vidéo mise à jour | Découvrez comment créer les propriétés de balise pour gérer les balises marketing sur votre site Web. |
...
| Publié | Nom | Type | Description |
| ----------| ---------- | ---------- |---------- |
| Décembre 2023 | [Importer des données dʼexemple vers Adobe [!DNL Experience Platform]](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/import-sample-data) | Article mis à jour | Découvrez comment configurer un environnement sandbox Experience Platform avec des données d’exemple. |
...
* [Notes de mise à jour d’AppMeasurement for JavaScript](https://experienceleague.adobe.com/fr/docs/analytics/implementation/appmeasurement-updates)
...
| Décembre 2023 | [Configuration des paramètres de variable globale pour l’extension Analytics dans les balises Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/configuring-global-variables-in-the-tags-analytics-extension.html?lang=fr) | Vidéo | Découvrez comment configurer les paramètres de variable globale dans l’extension Balises Analytics pour un site web de base. |
| Décembre 2023 | [Configuration des paramètres généraux de l’extension Analytics dans les balises Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/configuring-general-settings-in-the-tags-analytics-extension.html?lang=fr) | Vidéo | Découvrez les options de configuration générales de l’extension Analytics dans les balises Experience Platform, y compris la configuration du serveur de suivi. |
...
Regardez la [Vidéo de présentation de la version de janvier 2024](https://video.tv.adobe.com/v/3448931?captions=fre_fr&quality=12") pour obtenir un résumé des fonctionnalités ajoutées dans la version 2024.01.0 (janvier 2024).

### [!DNL Experience Manager Sites] as a [!DNL Cloud Service]

_Programme d’adoption précoce_

Vous pouvez utiliser le [Service de données de surveillance des utilisateurs et utilisatrices réels (RUM)](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/content-requests) pour activer la collecte côté client pour AEM as a Cloud Service.
...
* Les [autorisations personnalisées de Cloud Manager](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-permissions) vous permettent de créer des profils d’autorisation personnalisés avec des autorisations configurables afin de restreindre l’accès aux programmes, aux pipelines et aux environnements pour les utilisateurs et utilisatrices de [!DNL Cloud Manager].
...
* Les conteneurs de version prennent désormais en charge Node.js version 18 pour les [pipelines front-end](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/implementing/developing/developing-with-front-end-pipelines).
* Pour les programmes Cloud Manager nouvellement créés, [le sous-compte New Relic associé](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/user-access-new-relic) n’est pas activé par défaut.
...
* Les déploiements des mises à jour de l’[environnement de version](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details) [annoncés et introduits avec la version d’octobre 2023 de Cloud Manager](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/release-notes/cloud-manager/2023/2023-10-0) sont à présent terminés.
   * Ajout de la prise en charge de Node 18 pour les [pipelines front-end et full-stack](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines).
   ...
   * Maven a été mis à jour vers la version 3.8.8.
      ...
      * [Adobe recommande](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details) à sa clientèle de mettre à jour les référentiels Maven pour utiliser HTTPS au lieu de HTTP.
...
>[!NOTE]
>
>La prise en charge étendue par AEM 6.4 n’est désormais plus effective. Pour plus d’informations, voir la [période d’assistance technique](https://helpx.adobe.com/fr/support/programs/eol-matrix.html) d’Adobe. Recherchez les [versions prises en charge ici](https://experienceleague.adobe.com/fr/docs).
...
* [Mises à jour des versions d’Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/overview.html?lang=fr)
...
* [Notes de mise à jour du pack de services 6.5 d’Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-65/content/release-notes/release-notes.html?lang=fr)
...
* [Guides d’Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/overview/introduction.html?lang=fr)
...
* [Page d’accueil Formation et assistance pour Experience Manager 6.5](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/deploying/introduction/platform.html?lang=fr)
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Décembre 2023 | [[!DNL Workfront] : appliquer le modèle de mise en page](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23173.html?lang=fr) | Nouvel article | Découvrez comment appliquer le modèle de mise en page de quatre façons : [!UICONTROL Profil utilisateur], [!UICONTROL Fonction], [!UICONTROL Équipe locale], et [!UICONTROL Groupe local]. |
