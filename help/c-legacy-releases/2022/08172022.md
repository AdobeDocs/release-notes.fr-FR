...
Mise à jour prévue : **jeudi 24 août 2022**
...
* La [diffusion d’images optimisée pour le Web](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/web-optimized-image-delivery.html) d’Experience Manager as a Cloud Service améliore considérablement la vitesse de page en fournissant des formats tels que WebP. Ce nouveau service offre également plus des options de redimensionnement et de transformation d’image plus flexibles. Toutes les versions du [composant d’image principal](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/image.html) utilisent ce service ; ce qui vous permet de diffuser des images dans WebP en sélectionnant une option dans la politique du composant d’image.
...
* L’[Explorateur de référentiels](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/repository-browser.html) dispose désormais d’un champ d’entrée de chemin d’accès, ce qui permet de passer directement à un dossier spécifique dans la hiérarchie du référentiel.
...
* `mod_macro` est désormais disponible dans Experience Manager as a Cloud Service. [Consultez ce tableau pour obtenir &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html?lang=fr) liste des modules Apache pris en charge.
...
| Août 2022 | [Tutoriels AEM Headless](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html) | Articles mis à jour | Les tutoriels AEM Headless SDK ont été mis à jour afin d’utiliser les requêtes persistantes et WKND 2.0. Suivez des tutoriels pratiques pour découvrir comment utiliser les différentes options et choisir celles qui vous conviennent. | AEM as a Cloud Service |
...
* [Panneau de Contrôle version de juillet](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=fr)
...
| Août 2022 | [Configurer des paiements en ligne](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-sending/set-up-online-payments.html) | Vidéo | Découvrez comment configurer et accepter des paiements en ligne dans vos documents. | Acrobat Sign |
...
| Août 2022 | [Obtenir une signature en personne](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-signing/sign-in-person.html) | Vidéo | Découvrez comment obtenir la signature d’une tierce personne en personne à l’aide de l’[application mobile Acrobat Sign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/mobile/mobile-overview.html). | Acrobat Sign |
