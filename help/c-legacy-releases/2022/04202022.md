...
| Avril 2022 | [Traduire le langage technique Adobe Analytics en langage adapté à tous](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/translating-adobe-analytics-technical-language.html?lang=fr#) | Vidéo | En tant qu’expert Adobe Analytics de votre entreprise, vous êtes un élément clé pour aider vos parties prenantes à comprendre les détails techniques et à tirer le meilleur parti de votre investissement Adobe Analytics. |
| Avril 2022 | [Les segments rapides dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/quick-segments-in-analysis-workspace.html?lang=fr) | Vidéo | Les _segments rapides_ constituent une expérience de segmentation simplifiée qui s’effectue directement dans la zone de l’[!UICONTROL espace de travail]. Découvrez comment créer des segments à la volée contenant jusqu’à trois règles sans avoir à quitter votre workflow d’analyse. |
...
* **Experience Manager as a Cloud Service**
  ...
  Regardez la [vidéo de présentation de la version de mars 2022](https://video.tv.adobe.com/v/3454198?captions=fre_fr) pour un résumé des fonctionnalités ajoutées dans la version 2022.3.0 (mars 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
* **Cloud Manager**
  ...
  * L’importance de la [règle de qualité](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/code-quality-testing.html?lang=fr#understanding-code-quality-rules) BannedPath a été modifiée de bloqueur à critique.
  * L’assistant Pipeline informe l’utilisateur quand une mise à jour de l’environnement Experience Manager peut être nécessaire avant de configurer un [pipeline Config de couche Web](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html?lang=fr#web-tier-config-pipelines) associé.
