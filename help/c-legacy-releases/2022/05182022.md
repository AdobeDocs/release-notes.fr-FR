...
* **Experience Manager as a Cloud Service**
  ...
  Regardez la [vidéo de présentation de la version d’avril 2022](https://video.tv.adobe.com/v/3452778?captions=fre_fr&quality=12) pour un résumé des fonctionnalités ajoutées dans la version 2022.4.0 (avril 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
