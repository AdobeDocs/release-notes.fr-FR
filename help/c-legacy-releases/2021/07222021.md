...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
     ...
     Consultez [Experience Manager Guides](https://business.adobe.com/fr/products/experience-manager/guides/aem-guides.html) pour plus d’informations.
...
| -----------| ---------- | ---------- | ---------- |
| Juillet 2021 | [Affinage des cibles en combinant les résultats des requêtes](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/process-management/targeting-workflows/refine-targets-by-combining-query-results.html?lang=fr) | Campaign v8 | Découvrez comment affiner votre cible en combinant les résultats des requêtes dans un workflow à l’aide de l’intersection ou des activités d’union. |
