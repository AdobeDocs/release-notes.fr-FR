---
title: Notes de mise à jour centrales - Juin 2021
...
| -----------| ---------- | ---------- | ---------- |
| Juin 2021 | [Préparation des données avec le service de requête](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/prepare-data.html?lang=fr) | Vidéo | Découvrez comment nettoyer, préparer et combiner des données issues de plusieurs jeux de données afin de créer un jeu de données à lʼaide des fonctions Create Table AS (CTAS) et Spark SQL pour le compte rendu des performances et leur intégration à des tableaux de bord. |
| Juin 2021 | [Copie de schémas entre des sandbox](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/copy-schemas-between-sandboxes.html?lang=fr) | Vidéo | Découvrez comment copier un schéma d’un sandbox vers un autre dans Adobe Experience Platform à l’aide de l’[!UICONTROL API Export/Import Schema]. Créez et testez vos schémas dans les sandbox de développement, puis copiez-les vers les environnements de production. |
...
| Juin 2021 | [Connexion de Tableau au service de requête](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/psql-client-tableau.html?lang=fr) | Vidéo | Découvrez comment vous connecter au [!UICONTROL service de requête] à partir de plusieurs applications de bureau clientes qui prennent en charge le protocole `PostgreSQL` et apprenez comment utiliser les outils et pilotes `PostgreSQL` afin de connecter et écrire des requêtes. |
| Juin 2021 | [Fonctions définies par Adobe dans le service de requête](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/adobe-defined-functions.html?lang=fr) | Vidéo | Apprenez comment utiliser des fonctions définies par Adobe dans le [!UICONTROL service de requête] Adobe Experience Platform afin dʼexécuter des tâches commerciales courantes sur les données dʼévénement dʼexpérience. |
| Juin 2021 | [Exploration des données avec le service de requête](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/explore-data.html?lang=fr) | Vidéo | Apprenez comment valider les données ingérées, prévisualiser les données et explorer les propriétés statistiques et analytiques des données à lʼaide des fonctions SQL. |
| Juin 2021 | [Présentation du service de requête](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/understanding-query-service.html?lang=fr) | Vidéo | Découvrez le service de requête dans Adobe Experience Platform et comment il permet de comprendre le comportement des clientes et clients, et de générer des informations pertinentes. |
| Juin 2021 | [Présentation de lʼinterface utilisateur du service de requête](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/query-service-ui.html?lang=fr) | Vidéo | Apprenez comment écrire et exécuter des requêtes, afficher des requêtes précédemment exécutées et accéder à des requêtes enregistrées par dʼautres personnes au sein de votre organisation IMS dans le service de requête Adobe Experience Platform. |
| Juin 2021 | [API Query](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/query-service-api.html?lang=fr) | Vidéo | Apprenez comment écrire et exécuter des requêtes, créer des requêtes programmées et créer un modèle de requête à lʼaide de lʼ[!UICONTROL API Query Service] dʼAdobe Experience Platform. |
...
| Juin 2021 | [Configuration des rapports de recherche interne au site](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-use-cases/internal-site-search/configure-internal-site-search-reports.html) | Vidéo | Créez et configurez des tableaux à structure libre dans Analysis Workspace afin dʼanalyser la fonctionnalité de recherche interne de votre site. |
| Juin 2021 | [Mise en correspondance de variables SDK Web dans Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-use-cases/internal-site-search/map-web-sdk-variables-into-adobe-analytics.html) | Vidéo | Découvrez comment mettre en correspondance des variables Analytics du SDK Web vers Adobe Analytics à lʼaide de règles de traitement. |
| Juin 2021 | [Mise en œuvre de variables de recherche interne à lʼaide du SDK Web](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-use-cases/internal-site-search/implement-internal-search-variables-using-web-sdk.html) | Vidéo | Découvrez comment utiliser le SDK Web pour mettre en œuvre des variables Adobe Analytics pour un cas dʼutilisation de suivi dʼun terme de recherche interne. Affichez le flux de données de la page vers Experience Edge, puis vers Adobe Analytics. |
| Juin 2021 | [Mise en œuvre de variables de recherche interne à lʼaide dʼAppMeasurement](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-use-cases/internal-site-search/implement-internal-search-variables-using-appmeasurement.html) | Vidéo | Dans cette vidéo, découvrez les étapes de la mise en œuvre de variables de recherche de site interne pour Adobe Analytics à lʼaide de la collecte de données/Launch dʼExperience Platform, notamment le terme de recherche, le nombre de résultats, etc. |
| Juin 2021 | [Définition des besoins de votre entreprise en matière de recherche interne au site](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-use-cases/internal-site-search/defining-your-internal-site-search-business-requirements.html) | Vidéo | Lorsque vous décidez dʼeffectuer le suivi de la recherche interne sur votre site, il est important de déterminer dʼabord les aspects de la recherche que vous souhaitez suivre et les actions à entreprendre après lʼanalyse des résultats. Cette vidéo explique comment documenter les besoins de lʼentreprise. |
...
* Amélioration apportée au [rapport dʼutilisation des activités](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/activity-usage-reporting.html) qui vous permet désormais dʼexaminer les données datant de plus dʼun an. (AAM-58268)
...
Nouvelles fonctionnalités, correctifs et mises à jour Experience Manager (AEM). Adobe recommande à sa clientèle utilisant des déploiements sur site de déployer le dernier correctif pour garantir des performances et une stabilité optimales et renforcer la sécurité.
...
* **6.5.9.0** Experience Manager

  Experience Manager 6.5 Service Pack 9.0 (6.5.9.0 publiée le 27 mai 2021) est une mise à jour importante qui inclut de nouvelles fonctionnalités, des améliorations importantes demandées par les clients, des performances améliorées, une stabilité et une sécurité améliorées, publiées depuis la disponibilité générale d’AEM 6.5 en avril 2019.
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Amélioration de lʼexpérience utilisateur permettant dʼafficher le nombre de ressources présentes dans un dossier. Pour plus de 1 000 assets dans un dossier, Experience Manager Assets affiche plus de 1 000.

     Nouveautés de la version [!UICONTROL Dynamic Media] :
...
* [Recommandations pour la soumission d’une nouvelle idée Experience Manager](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/guidelines-for-submitting-a-new-experience-manager-aem-idea/td-p/382376)
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Juin 2021 | [Requêtes persistantes GraphQL](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/graphql-persisted-queries.html) | Vidéo | Découvrez comment activer, créer, mettre à jour et exécuter des requêtes persistantes dans Experience Manager. |
| Juin 2021 | [Création de votre premier servlet dans AEM Forms](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-osgi-bundle/create-servlet.html) | Article | Créez votre première servlet Sling afin de fusionner des données avec un modèle de formulaire. |
| Juin 2021 | [Création de votre premier service OSGi avec Experience Manager Forms](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-osgi-bundle/create-osgi-service.html) | Article | Créez votre premier service OSGi avec AEM Forms afin de générer un fichier PDF en fusionnant les données avec un modèle. |
...
* **Adobe Campaign Classic v7 (version 21.1.3) :** pour en savoir plus, consultez les [Notes de mise à jour de Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=fr).
...
| Fonctionnalité | Description |
| ------- | ----------- |
| [!UICONTROL Campagnes] | (Campagnes Google Ads) [!UICONTROL Advertising Cloud Search] synchronise, optimise et fournit désormais l’attribution pour les annonces d’inventaire local dans les campagnes d’achats.<br><br>Configurez et gérez vos annonces d’inventaire local dans Google Ads. |
|  | Lorsque vous modifiez plusieurs campagnes et composants de campagne, vous ne pouvez plus enregistrer vos modifications sous forme de brouillons pour les consulter dans la vue en attente ni planifier les modifications à une date ultérieure. Toutes les tâches planifiées existantes seront quand même exécutées comme prévu. |
| [!UICONTROL Advertising Insights] | Les informations suivantes sont disponibles en mode Beta :<ul><li>[!UICONTROL Normalized Sim (Combined) Beta]</li><li>[!UICONTROL Portfolio Launch Beta]</li> |
| [!UICONTROL Centre de notifications Beta] | Vous pouvez désormais recevoir et gérer les notifications en dehors de votre navigateur en installant l’application [!UICONTROL Centre de notifications Beta] pour Google Chrome 40 et versions ultérieures ou Microsoft Edge 17 et versions ultérieures. L’application se charge plus rapidement que la version standard du navigateur et est automatiquement mise à jour.<br><br>Une fois l’application installée, l’application web s’ouvre dans une fenêtre distincte qui réorganise dynamiquement sa disposition en fonction de la taille de la fenêtre. Vous n’avez pas besoin de vous connecter à l’application ni d’ouvrir une fenêtre de navigateur pour l’utiliser. |
|  | Un nouveau type d’alerte est disponible, [!UICONTROL Actions de l’interface utilisateur de Campaign Management], qui affiche le statut final de toutes les tâches en arrière-plan, y compris les modifications en masse et les modifications d’affectation apportées aux portfolios, aux contraintes, aux classifications et aux événements. Vous êtes automatiquement abonné aux alertes pour les actions de l’interface utilisateur.<br><br>Ce type d’alerte remplacera à terme les notifications de statut des tâches héritées disponibles dans la barre d’outils de droite (notifications de statut des tâches héritées). |
| Rapports | Le nouveau [!UICONTROL Rapport de campagne toutes les heures] affiche les données relatives au coût, aux clics et (éventuellement) aux conversions pour une ou plusieurs campagnes Google avec des mots-clés pour chaque heure de la période spécifiée. Ce rapport est identique au [!UICONTROL Rapport de campagne] avec une agrégation des données « Toutes les heures » ou « Jour de la semaine (toutes les heures) ». Ces types d’agrégation seront rendus obsolètes dans le [!UICONTROL Rapport de campagne] dans une version ultérieure. |
