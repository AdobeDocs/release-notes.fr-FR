...
| Avril 2021 | [Comprendre la gouvernance des données dans Real-time CDP pour les utilisateurs Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-data-gov-for-aam-users.html?lang=fr#other-integrations) | Vidéo | Cette vidéo explique aux utilisateurs Audience Manager la fonctionnalité de gouvernance des données dans [!UICONTROL Real-time Customer Data Platform], en la comparant à ce qui était disponible dans Audience Manager. Elle aborde le cadre [!UICONTROL DULE] (Data Usage Labeling &amp; Enforcement) et où, dans Platform, il peut être appliqué. |
...
| Avril 2021 | [Création du premier [!UICONTROL formulaire adaptatif]](https://video.tv.adobe.com/v/3411775?captions=fre_fr) | Vidéo | Découvrez comment créer un premier formulaire adaptatif. |
