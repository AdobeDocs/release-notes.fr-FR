...
| Octobre 2021 | [[!UICONTROL Outil de transfert de contenu]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/content-migration/content-transfer-tool.html?lang=fr) | Vidéo | Découvrez comment lʼ[!UICONTROL outil de transfert de contenu] vous aide à faire migrer le contenu dʼAEM 6.3 et versions ultérieures vers AEM as a Cloud Service. |
...
| Octobre 2021 | [Utilisation des API SOAP dans les workflows - Présentation](https://experienceleague.adobe.com/docs/campaign-learn/use-soap-apis/introduction.html?lang=fr) | Tutoriel | Découvrez comment utiliser les API Soap Adobe Campaign et créer un workflow de diffusion avancé basé sur les données reçues via l’API. |
