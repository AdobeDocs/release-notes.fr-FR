...
Publication : **jeudi 9 septembre 2020**
...
Version de septembre - Voir [Notes de mise à jour pour Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=fr#september-release).
...
* [Nouvelles fonctionnalités de Customer Journey Analytics](#cust-journey) (mise à jour le 7 octobre 2020)
...
| Fonctionnalité | [Disponibilité générale](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=fr) - Date cible | Description |
| ----------- | ---------- | ---------- |
| Panneau [!UICONTROL Observateur simultané de médias] dans [!UICONTROL Workspace] | 17 septembre 2020 | Le panneau [!UICONTROL Observateurs simultanés de médias] vous permet de déterminer où s’est produit le pic d’accès simultané ou où des abandons ont eu lieu. Il fournit une insight précieuse sur la qualité du contenu et l’engagement des observateurs et aide à la résolution des problèmes ou à la planification du volume/de l’échelle. [En savoir plus...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/media-concurrent-viewers.html?lang=fr) |
...
| Fin de vie des Data Connectors Adobe | 13 juillet 2020 | Les [!UICONTROL Data Connectors] Adobe sont alimentés par une technologie héritée qui n’est plus viable ni prise en charge. Nous disposons d’un nouveau standard dans le [Programme de partenariat Adobe Exchange](https://partners.adobe.com/exchangeprogram/experiencecloud) qui devrait être adopté pour toutes les intégrations qui souhaitent continuer à être proposées et prises en charge. La date officielle de fin de vie reste à déterminer, mais nous prévoyons qu&#39;elle le sera au cours des 12 à 18 prochains mois (de la mi-2021 à la fin de 2021). [En savoir plus...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=fr) |
...
| 14 septembre 2020 | [Utilisation de mesures dans un tableau à structure libre](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/working-with-metrics-in-a-freeform-table.html?lang=fr) | Vidéo | Découvrez les différentes manières d’utiliser les mesures dans une table à [!UICONTROL structure libre] dans [!UICONTROL Analysis Workspace]. |
| 14 septembre 2020 | [Télécharger 50 000 éléments au format CSV](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/download-50000-items-as-csv.html?lang=fr) | Vidéo | L’option [!UICONTROL Télécharger les éléments au format CSV] vous permet de télécharger jusqu’à 50 000 éléments pour une dimension dans une table à [!UICONTROL structure libre], avec des segments et des filtres appliqués. Bien que l’interface utilisateur continue à afficher jusqu’à 400 éléments avant la pagination, cette option vous permet d’accéder à davantage de lignes de données en dehors d’[!UICONTROL Analysis Workspace]. |
| 14 septembre 2020 | [Visualisation Ligne dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/line-visualization-in-analysis-workspace.html?lang=fr) | Vidéo | La visualisation Ligne représente les mesures sur une période de tendance. Les paramètres de visualisation vous permettent de personnaliser l’aspect visuel de chaque ligne et incluent les paramètres Afficher l’axe X/Y, Afficher les libellés min/max et Afficher la ligne de tendance. |
| 14 septembre 2020 | [Paramètres de ligne et de colonne dans les tableaux à structure libre](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/row-and-column-settings-in-freeform-tables.html?lang=fr) | Vidéo | Découvrez les paramètres des tables à [!UICONTROL structure libre] dans Analysis Workspace et comment ils affectent les données qui s’y trouvent. |
| 14 septembre 2020 | [Utilisation des dimensions dans un tableau à structure libre](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/working-with-dimensions-in-a-freeform-table.html?lang=fr) | Vidéo | Découvrez comment utiliser les dimensions dans les tables à [!UICONTROL structure libre], y compris les ajouter, les trier, les filtrer, les ventiler selon d’autres dimensions, etc. |
| 14 septembre 2020 | [Utilisation du rail de gauche pour créer des tableaux à structure libre dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/using-the-left-rail-to-build-freeform-tables-in-analysis-workspace.html?lang=fr) | Vidéo | Découvrez comment utiliser le rail de gauche dans Analysis Workspace pour rechercher, créer et ajouter des éléments aux tables à [!UICONTROL structure libre]. |
...
* Correction d’un problème avec l’API REST Audience Manager, en raison duquel le point d’entrée des caractéristiques ne renvoyait pas de mesures inter-appareils lors du filtrage des caractéristiques dans la requête. (AAM-55878)
...
[La documentation sur l’accessibilité](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/accessibility-in-aam.html?lang=fr) est désormais disponible pour Audience Manager.
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| 14 septembre 2020 | [Créer une taxonomie des caractéristiques](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-a-trait-taxonomy.html?lang=fr) | Vidéo | Découvrez des conseils sur la création de structures de dossiers contenant vos caractéristiques dans Audience Manager. |
| 14 septembre 2020 | [Création de caractéristiques intégrées](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-onboarded-traits.html?lang=fr) | Vidéo | Découvrez des conseils sur la création de caractéristiques intégrées dans Audience Manager. |
...
* **AEM as a Cloud Service**
   ...
   * **Adobe Experience Manager Commerce as a Cloud Service**
      ...
      * Publication des composants principaux de CIF version 1.3.0. Voir [Composants principaux CIF](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.3.0) pour plus d’informations.
...
* Pour Assets Insights, utilisez [Adobe Launch](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/advanced/asset-insights-launch-tutorial.html?lang=fr). [L’intégration de DTM](https://experienceleague.adobe.com/docs/experience-manager-65/assets/managing/touch-ui-using-dtm-for-asset-insights.html?lang=fr) est appelée comme une méthode obsolète dans la documentation de .
...
| 23 septembre 2020 | [Suivi des composants cliqués avec Adobe Analytics](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/analytics/track-clicked-component.html?lang=fr) | Article | Utilisez la couche de données client Adobe orientée événement avec les composants principaux AEM pour effectuer le suivi des clics sur des composants spécifiques sur un site Adobe Experience Manager. Découvrez comment utiliser les règles dans Experience Platform Launch pour écouter les événements de clic, filtrer par composant et envoyer les données à un Adobe Analytics avec une balise de lien de suivi. |
...
| 25 septembre 2020 | [Déploiement sur Adobe I/O Runtime](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/deploy/runtime.html?lang=fr) | Article | Les projets Asset Compute, et les objets Worker qu’ils contiennent, doivent être déployés sur Adobe I/O Runtime pour être utilisés par AEM as a Cloud Service. |
...
| 21 septembre 2020 | [Configuration du fichier manifest.yml](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/develop/manifest.html?lang=fr) | Article | Le fichier manifest.yml du projet Asset Compute décrit tous les objets Worker de cette application à déployer. |
| 25 septembre 2020 | [Personnalisation de la notification d’affectation de tâche](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/handling-af-form-submissions/customize-assign-task-notification.html?lang=fr) | Article | Utilisez les données de formulaire des emails de notification de tâche dans les workflows AEM. |
...
| 21 septembre 2020 | [Extensibilité des microservices Asset Compute](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/overview.html?lang=fr) | Vidéo | Tutoriel qui décrit la création d’un objet Worker de microservices de ressources personnalisé pour AEM as a Cloud Service. |
| 21 septembre 2020 | [Extensibilité des microservices Asset Compute](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/overview.html?lang=fr) | Vidéo | Les microservices Asset Compute d’AEM as a Cloud Service prennent en charge le développement et le déploiement des objets Worker personnalisés utilisés pour lire et manipuler les données binaires des ressources stockées dans AEM, le plus souvent, pour créer des rendus de ressources personnalisés. |
...
* Version 20.2.3 - [En savoir plus](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=fr#release-20-2-3-build-9182)
...
* Version 20.4 - [En savoir plus](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=fr#release-20-4---october-2020)
...
| 22 septembre 2020 | [Journey IA - Score d’engagement prédictif - Vidéo](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/communication-channels/email/journey-ai/predictive-engagement-scoring.html?lang=fr) | Campaign Standard | Découvrez comment afficher les scores d’engagement au niveau de chaque profil, les utiliser pour cibler les profils les plus engagés, exclure ceux qui présentent des signes de lassitude et créer des règles de typologie pour gérer la fatigue des clientes et clients. |
...
| 11 septembre 2020 | [Délégation de sous-domaines](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/administrating/control-panel-acc/subdomain-delegation.html?lang=fr) | Campaign Classic | Le Panneau de contrôle d’Adobe Campaign vous permet de déléguer entièrement un sous-domaine à Adobe Campaign. |
| 3 septembre 2020 | [Ajout d’adresses IP aux listes autorisées](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/administrating/control-panel-acc/ip-allow-listing.html?lang=fr) | Campaign Classic | Le Panneau de contrôle permet de configurer de nouvelles connexions à vos instances en ajoutant des plages d’adresses IP aux listes autorisées. Par défaut, une instance Adobe Campaign Classic n’est pas accessible à partir de diverses adresses IP. |
| 3 septembre 2020 | [Panneau de contrôle - Ajout des autorisations d’URL](https://experienceleague.adobe.com/docs/campaign-learn/campaign-classic-tutorials/administrating/control-panel-acc/adding-url-permissions.html?lang=fr) | Campaign Classic | Le Panneau de contrôle permet de configurer de nouvelles connexions à vos instances en ajoutant des plages d’adresses IP aux listes autorisées. Par défaut, une instance Adobe Campaign Classic n’est pas accessible à partir de diverses adresses IP. |
...
| -----------| ---------- |
| Inventaire privé | Tous les utilisateurs peuvent désormais configurer et modifier les détails de l’ID de la transaction en utilisant un nouveau formulaire d’ID de transaction, qui est une version simplifiée de l’ancien formulaire [!UICONTROL Diffusion dynamique des publicités]. Pour configurer les détails de l’ID de la nouvelle transaction, accédez à **[!UICONTROL Inventaire > Transactions]**, sélectionnez **[!UICONTROL Créer]**, puis **[!UICONTROL ID de transaction Beta]**. |
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| 30 septembre 2020 | [Présentation rapide d’Adobe Sign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/quick-tour.html?lang=fr) | Vidéo | Découvrez rapidement l’interface Adobe Sign pour être opérationnel. |
