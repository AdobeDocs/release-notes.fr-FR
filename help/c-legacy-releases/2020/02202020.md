...
* [Interface et services principaux d’Experience Cloud](#ecloud) (date ajoutée : **26 février 2020**)
...
* **Labs (Technology Previews) :** cette nouvelle fonctionnalité d’Analytics vous permet de tester de nouveaux prototypes de fonctionnalités en production et de fournir des commentaires précieux à Adobe. [En savoir plus...](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html)
...
* **Navigateur Edge Microsoft® basé sur Chromium :** cette version comprend des modifications pour reconnaître le navigateur Edge Microsoft® basé sur Chromium (version 79 et ultérieures) à des fins de création de rapports.
...
* Correction d’un problème en raison duquel le nom d’un segment publié, mis à jour dans Analytics, ne se mettait pas à jour dans Audience Manager dans un délai de 24 heures. (AN-199974)
...
Voir les notes de mise à jour d’[AppMeasurement for JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=fr). La version 2.19.0 a été publiée le 21 février 2020.
...
Voir la section [Générer plusieurs communications interactives à l’aide de l’API Batch](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/generate-multiple-interactive-communication-using-batch-api.html).
...
Voir la section [Plateformes prises en charge pour AEM Forms sur JEE](https://experienceleague.adobe.com/docs/experience-manager-65/forms/install-aem-forms/jee-installation/aem-forms-jee-supported-platforms.html).
...
* [Mise à jour de Campaign Classic 19.2.3](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-2.html)
