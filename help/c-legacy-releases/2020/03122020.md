...
AEM 6.5 Service Pack 4.0 (6.5.4.0 publiée le 5 mars 2020) est une mise à jour importante qui inclut de nouvelles fonctionnalités, des améliorations client importantes, une amélioration des performances, de la stabilité et de la sécurité, publiée depuis la disponibilité générale d’AEM 6.5 en avril 2019.
   * [Nouveautés de Adobe Experience Manager 6.5 Service Pack 4](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=fr)
   ...
   * [Éléments livrables de la version d’AEM Forms](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=fr)
...
* **6.4.8.0** AEM
   ...
   * [Versions du CFP AEM Forms](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=fr)
...
* **AEM Assets Brand Portal**
  ...
  AEM Assets Brand Portal 6.4 Service Pack 6 (6.4.6 publiée le 5 mars 2020) modifie la configuration d’AEM Assets avec [!UICONTROL Brand Portal.] En outre, la version comprend d’autres améliorations et correctifs de bugs.
...
Voir [Configuration d’AEM Assets avec Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/publish/configure-aem-assets-with-brand-portal.html?lang=fr).
