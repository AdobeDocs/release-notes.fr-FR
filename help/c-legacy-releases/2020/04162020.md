...
| Fonctionnalité | Description |
| -----------| ---------- |
| [!UICONTROL Customer Journey Analytics] : renvoi des jeux de données automatisé | Cette nouvelle option permet d&#39;importer l&#39;ensemble des données historiques pour une connexion dans [!UICONTROL Customer Journey Analytics]. [En savoir plus](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html?lang=fr) |
