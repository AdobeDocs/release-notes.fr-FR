...
* **AEM6.5.3.0**
AEM 6.5, Service Pack 3.0 (6.5.3.0 publiée le 12 décembre 2019) est une mise à jour importante qui inclut des correctifs clients importants publiés depuis la disponibilité générale d’AEM 6.5 en avril 2019.
...
* **6.4.7.0** AEM
  ...
  AEM 6.4, Service Pack 7.0 (6.4.7.0 publiée le 12 décembre 2019) est une mise à jour importante qui inclut des correctifs clients clés publiés depuis la disponibilité générale d’AEM 6.4, avril 2018.
   * [Notes de mise à jour](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/sp-release-notes.html)
   * [Versions du CFP AEM Forms](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=fr)

* **6.3.3.7** AEM

  AEM 6.3, Service Pack 3, Cumulative Fix Pack 7 (6.3.3.7 publiée le 12 décembre 2019) est une mise à jour importante qui inclut des correctifs clients importants publiés depuis la disponibilité générale d’AEM 6.3, avril 2017.
...
* **Application De Bureau AEM2.0.1.1**

  L’application de bureau AEM 2.0.1.1 fournit une mise à jour pour l’authentification SSO avec Okta et la possibilité de spécifier l’emplacement des fichiers temporaires dans les préférences. Avec cette version, le support d’AEM 6.3.x est abandonné pour l’application de bureau 2.x.
...
* **Service de conversion automatisée de formulaires**
   ...
   * [Configuration du service](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
   * [Convertir PDF forms en formulaires adaptatifs](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html)
...
Voir [Prévisualisation de ressources 3D](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html).

* **Composants principaux**

  La version 2.8.0 des composants principaux, avec de nombreux correctifs, est désormais disponible avec la [documentation de création](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=fr). [Les détails de développement et le téléchargement de projets sont disponibles sur GitHub](https://github.com/adobe/aem-core-wcm-components).

* **Archétype de projet AEM**

  Le [module ui.frontend](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/uifrontend.html) de l’[archétype de projet AEM](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=fr) est un outil utile et flexible qui facilite le développement frontal de votre projet AEM.
...
>[!CAUTION]
>
>Ces fonctionnalités seront disponibles en version Beta d’ici la fin janvier et feront l’objet de fréquentes mises à jour et modifications sans préavis.
...
| Rechercher > Campagnes, Rapports | Les mesures de proéminence des publicités Google « Impr. (Abs. Haut) % » et « Impr. (Haut) % » sont désormais disponibles dans tous les rapports de base et les vues de gestion de campagnes au niveau de l’entité, à l’exception de ceux pour les groupes de produits d’achat, dans les rapports Taux d’impressions quotidien de la campagne et Taux d’impressions quotidien des mots-clés , ainsi que dans les vues libellés et contraintes . |
...
| Inights > Alertes Beta, Recherche > Campagnes | (Fonction Beta pour les comptes de recherche uniquement) Une nouvelle version Beta des alertes vous permet de créer des modèles d’alerte afin d’identifier quand une campagne de recherche, un groupe publicitaire, un mot-clé ou une publicité répond à des conditions spécifiques, comme des mesures de performances, pendant une période spécifiée. Si les conditions sont réunies, une alerte est générée. Les alertes sont disponibles pour un seul annonceur. |
| Rapports | Les données relatives aux publicités avec liste de produits sont désormais incluses dans les rapports Classification d’étiquette, Valeur de libellé, Règle sur l’offre et Contrainte. |
