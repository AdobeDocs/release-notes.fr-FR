...
Publication : **jeudi 14 octobre 2020**
...
| vendredi 8 octobre 2020 | [Tableaux à structure libre, fondation d’Analysis](https://video.tv.adobe.com/v/41766) | Vidéo | Apprenez ce que vous devez savoir et ce que vous apprendrez lorsque vous débuterez ce parcours de formation. |
...
* [Documentation du produit Adobe Analytics](https://experienceleague.adobe.com/docs/analytics.html?lang=fr)
...
* **AEM as a Cloud Service**
   ...
   * **Adobe Experience Manager Commerce as a Cloud Service**
      ...
      * Publication des composants principaux de CIF version 1.3.0. Voir [Composants principaux &#x200B;](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.3.0) pour plus d’informations.
...
* **Améliorations de Brand Portal** : les nouvelles fonctionnalités suivantes, entre autres, sont disponibles dans [!DNL Brand Portal] :
   ...
   * Un délai d’expiration de 15 minutes pour les sessions d’utilisateurs de client/cliente garantit une meilleure expérience à tous les utilisateurs simultanés.
...
| vendredi 8 octobre 2020 | [Exporter le fragment d’expérience vers Adobe Target](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/target/export-experience-fragment-target.html?lang=fr) | Vidéo | Découvrez comment exporter un fragment d’expérience AEM en tant qu’offres Adobe Target. |
...
* [Notes de mise à jour du pack de services 6.5 d’AEM](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html?lang=fr)
* [Notes de mise à jour du pack de correctifs cumulés AEM 6.4](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/cfp-release-notes.html?lang=fr)
* [Notes de mise à jour d’AEM Assets Dynamic Media](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/release-notes/s7rn2017.html?lang=fr)
...
* [Notes de mise à jour de l’appli de bureau AEM](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html?lang=fr)
...
* [Guides d’AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=fr)
* [Page d’accueil Formation et assistance pour AEM 6.5](https://helpx.adobe.com/fr/support/experience-manager/6-5.html)
* [Page d’accueil Formation et assistance pour AEM 6.4](https://helpx.adobe.com/fr/support/experience-manager/6-4.html)
* [Page d’accueil Formation et assistance pour AEM 6.3](https://helpx.adobe.com/fr/support/experience-manager/6-3.html)
* [Page d’accueil Formation et assistance pour AEM 6.2](https://helpx.adobe.com/fr/support/experience-manager/6-2.html)
...
* [Anciennes versions de la documentation AEM](https://helpx.adobe.com/fr/experience-manager/aem-previous-versions.html)
* [Page de départ Aide de Dynamic Media Classic](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/home.html?lang=fr)
...
* [Centre d’apprentissage Adobe Acrobat](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/overview.html?lang=fr)
* [Centre d’apprentissage Adobe Sign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/overview.html?lang=fr)
