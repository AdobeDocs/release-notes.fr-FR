...
* Correction d’un problème qui empêchait le filtrage des colonnes  par la dimension « non spécifié ». (AN-222393)
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| 30 août 2020 | [Enregistrement, partage et collaboration sur des projets dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/saving-sharing-and-collaborating-on-projects-in-analysis-workspace.html?lang=fr) | Vidéo | Dans [!UICONTROL Analysis Workspace], apprenez à ajouter des explications textuelles à un tableau, à créer un lien direct pour votre projet et à le partager. |
| 28 août 2020 | [Présentation du cours - Attribution de valeur aux points de contact numériques dans le parcours client](https://video.tv.adobe.com/v/346845?captions=fre_fr) | Vidéo | Dans cette vidéo d’introduction, découvrez les conditions préalables et le contenu du cours [Attribution de valeur aux points de contact numériques dans le parcours client](https://experienceleague.adobe.com/?recommended=Analytics-U-1-2020.2&lang=fr). |
| 28 août 2020 | [Attribution de valeur aux points de contact numériques dans le parcours client](https://experienceleague.adobe.com/?recommended=Analytics-U-1-2020.2&lang=fr) | Cours | Familiarisez-vous avec les visiteurs de votre site en comprenant ce qui les a amenés sur votre site, comment allouer du crédit pour la conversion sur votre site à différents canaux, et même comprendre comment d’autres éléments de votre site génèrent des conversions. Ce cours vous explique les principales visualisations qui montrent cette analyse, ainsi que comment utiliser [!UICONTROL Attribution IQ] pour attribuer des modèles d’attribution dans votre analyse. |
...
| 21 août 2020 | [Création et stratégies de segments d’audience](https://experienceleague.adobe.com/?recommended=AudienceManager-U-1-2020.2&lang=fr) | Cours | Dans ce cours, découvrez les segments de A à Z. Découvrez comment les créer, les gérer et les activer vers les partenaires de destination. Consultez des cas d’utilisation utiles et obtenez même quelques conseils et astuces de la part des clients. |
...
* **AEM6.5.6.0**
AEM 6.5 Service Pack 6 (6.5.6.0 publiée le 3 septembre 2020) est une mise à jour importante qui inclut de nouvelles fonctionnalités, des améliorations client importantes, des performances améliorées, une stabilité et une sécurité, publiée depuis la disponibilité générale d’AEM 6.5 en avril 2019.
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * Le transcodage vidéo est désormais pris en charge avec les microservices de ressources, avec une nouvelle section [!UICONTROL Vidéo] dans l’écran [!UICONTROL Profils de traitement] qui prend en charge la configuration du débit et des dimensions vidéo (le format de sortie est MP4 avec le codec H.264). Pour plus d’informations, voir [&#x200B; Gestion des ressources vidéo &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/manage-video-assets.html?lang=fr#transcode-video). Pour obtenir plus d’options de transcodage et de diffusion vidéo, vous pouvez utiliser le module complémentaire [!UICONTROL Dynamic Media].
...
* **Experience Manager [!UICONTROL Application De Bureau]2.0.3.2**
