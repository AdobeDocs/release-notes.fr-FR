...
Mise à jour : **mercredi 27 mai 2025**

+++Événements à venir

* **[!DNL Content Analytics]** | _Adobe Experience League LIVE : Content Analytics : Optimisation des performances avec les informations d’IA_ | Rejoignez-nous pour un événement en direct enrichissant d’une heure qui nous fera plonger dans l’univers transformateur de Content Analytics, optimisé par la technologie de pointe de l’IA d’Adobe. Cette session explorera la manière dont Content Analytics peut révolutionner la manière dont vous mesurez, comprenez et optimisez les performances du contenu.  | **Reporté au 28 mai** | [S’inscrire](https://engage.adobe.com/ExpLeagueLive-250522.html?sdid=NGWGR6CF&amp;mv=other)

* **[!DNL Workfront]** | _Démarrer rapidement, évoluer intelligemment : favoriser le succès des équipes avec la planification Workfront_ | Le déploiement d’une nouvelle solution de planification au sein d’une entreprise peut sembler être une tâche colossale : coûteuse, lente et déconnectée des besoins des équipes qui veulent simplement accomplir leurs tâches dès maintenant. Au cours de cette session, nous allons explorer le modèle de mise en œuvre locale et globale, et vous montrer comment les utilisateurs et utilisatrices précoces utilisent la planification Workfront pour générer rapidement de la valeur, sans attendre le consensus à l’échelle de l’entreprise.  | **Mercredi 28 mai** | [S’inscrire](https://events.teams.microsoft.com/event/2fa2a2f4-ada5-4810-9014-aa7fe34d0354@fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL Workfront]** | _Tirer parti de la puissance de Workfront Data Connect_ | Vous souhaitez améliorer vos rapports Workfront ? Inclus dans le package Ultimate, mais disponible en tant que module complémentaire ($) pour les clientes et clients Select ou Prime, ce webinaire d’une heure organisé en partenariat avec l’équipe de gestion de produits Adobe Workfront vous présentera Data Connect et ses fonctionnalités.  | **Jeudi 29 mai** | [S’inscrire](https://events.teams.microsoft.com/event/5adb7454-e13d-408d-a430-eb3a69a08510@fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL Experience Manager Guides]** | _Adobe DITAWORLD 2025_ | Préparez-vous à vous joindre à nous du 3 au 5 juin 2025, pour trois jours de présentations par des expertes et experts et de conversations passionnantes avec des acteurs et actrices du secteur. | **Du 3 au 5 juin** | [S’inscrire](https://2025-adobe-dita-world.meetus.adobeevents.com/?utm_campaign=community_forum&amp;utm_source=experience_league)

* **[!DNL Workfront]** | _Réveillez-vous avec Workfront : optimiser pour progresser. Contrôle et alignement de votre instance Adobe Workfront_ | Que vous ayez hérité d’une instance Adobe Workfront ou que vous en gériez une depuis des années, une révision structurée est la première étape vers un succès à long terme. Nous vous expliquerons comment évaluer votre instance avec clarté et dans un but précis : en identifiant ce qui fonctionne, où se trouvent les opportunités et comment préparer le terrain pour une amélioration évolutive. | **Jeudi 5 juin** | [S’inscrire](https://events-emea5.adobeconnect.com/content/adobeconnect/43/5415868397/en/events/event/shared/5748588430/event_landing.html?sco-id=5748605291&amp;campaign-id=ExL&amp;_charset_=utf-8)
