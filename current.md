...
| -----------|---------- | ----|
| [Adobe Analytics - Experience Makers - échange de compétences](https://events.bizzabo.com/389219?promo=ExperienceLeague&amp;tr=true) | L&#39;échange de compétences | Rejoignez-nous pour cet événement numérique gratuit de trois heures entièrement consacré à Adobe Analytics. Posez en direct des questions sur les experts et les pairs qui connaissent le mieux Workspace.<br>18 mai 2022 @ 1:30pm-4:15 h (EST)<br> [Détails &amp; inscription](https://events.bizzabo.com/389219?promo=ExperienceLeague&amp;tr=true) |
...
| [Marketo Skill Exchange](https://experienceleague.adobe.com/docs/skill-exchange-events/events/marketo/aug2021/marketo-roadmap.html?lang=en) | Vidéos à la demande | Découvrez l’importance de votre feuille de route Marketo et comment éviter une mauvaise planification. Obtenez des conseils sur le déverrouillage des champs personnalisés des membres de programme, des astuces et des astuces sur les Marketo Engage, et bien plus encore dans la section [!DNL Marketo] Échange de compétences d&#39;août 2021, désormais en Experience League. |
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Mai 2022 | [Informations sur les prépartages de la correspondance de segment](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/segment-match-pre-share-insights.html) | Vidéo | Lorsque vous décidez avec un partenaire stratégique de partager des données, il est important de savoir comment vos clients s’associent, afin que vous sachiez à quel point ce partage de données sera utile. La correspondance de segment vous permet de voir le chevauchement avec les partenaires de données potentiels avant de partager des données. | [!DNL Real-time Customer Data Platform] |
| Mai 2022 | [Configuration de la connexion de correspondance de segment](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/segment-match-connection-setup.html?lang=en) | Vidéo | découvrez comment configurer la connexion entre vous et un partenaire afin de partager des audiences. Après avoir configuré cette fonction de correspondance de segment, vous pourrez partager des données entre vous et votre partenaire de données. | [!DNL Real-time Customer Data Platform] |
| Mai 2022 | [Gouvernance des données de correspondance de segment](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/segment-match-data-governance.html?lang=en) | Vidéo | Découvrez comment configurer et utiliser les contrôles de gouvernance des données dans Real-Time CDP afin de pouvoir limiter les jeux de données (et donc les segments qui utilisent ces jeux de données) qui peuvent être partagés avec les partenaires de données. | [!DNL Real-time Customer Data Platform] |
| Mai 2022 | [Flux de configuration de correspondance de segment](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/segment-match-configuration-flow.html?lang=en) | Vidéo | Découvrez le processus de configuration d’une [!UICONTROL Correspondance de segment] pour un partage de données. | [!DNL Real-time Customer Data Platform] |
| Mai 2022 | [Connexion aux destinations](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/connecting-to-destinations.html) | Vidéo | Avant de pouvoir envoyer des données aux partenaires de destination à partir de la plateforme de données clients en temps réel, vous devez d’abord établir les connexions avec ces partenaires. Cette vidéo décrit ce processus, généralement réalisé par des administrateurs. | [!DNL Real-time Customer Data Platform] |
| Mai 2022 | [Création de schémas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/create-schemas.html) | Vidéo | Cette vidéo montre comment créer des schémas dans Adobe Experience Platform à l’aide de la classe XDM Individual Profile et de divers groupes de champs. | Experience Platform |
| Mai 2022 | [Analyse et visualisation des informations omnicanal dans Tableau à l’aide de Query Service](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/analyze-and-visualize.html) | Vidéo | Découvrez comment utiliser Query Service de Adobe Experience Platform avec des outils de visualisation de données externes à l’aide d’un exemple d’analyse de perte de clientèle. | Experience Platform |
...
| -----------| ---------- | ---------- | ---------- |
| Mai 2022 | [Prise en main du Report Builder](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/get-started-with-report-builder.html?lang=en) | Vidéo | Découvrez les principes de base de l’utilisation de Report Builder, notamment l’installation, la connexion et les demandes de données. |
| Mai 2022 | [Parcourir la nouvelle landing page](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/navigating-the-new-landing-page.html?lang=en) | Vidéo | Découvrez comment tirer le meilleur parti de la nouvelle page d’entrée Analytics et de ses fonctionnalités. |
| Mai 2022 | [Panneaux et rapports de l’espace de travail de résumé de page et de suivant/précédent](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/using-panels/next-previous-and-page-summary-workspace-panels-reports.html) | Vidéo | Voir les deux nouveaux types de panneau dans Analysis Workspace : Suivant/Précédent et Résumé de la page. Celles-ci permettent à Workspace d’être à égalité avec certains des plus populaires [!UICONTROL Reports &amp; Analytics] rapports. |
| Mai 2022 | [Mises à jour des landing pages Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/analysis-workspace-landing-page-updates.html?lang=en) | Vidéo | Découvrez quelques-unes des améliorations et ajouts majeurs apportés à la nouvelle landing page. Nous avons pris connaissance des commentaires de vos clients et tenté d’incorporer les fonctionnalités les plus importantes telles que le redimensionnement des colonnes, les nouveaux types de colonnes, les liens vers les rapports en temps réel et de robots, etc. |
| Mai 2022 | [Posez-vous les bonnes questions ?](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/are-you-asking-the-right-questions.html) | Vidéo | Découvrez comment il est plus utile d’identifier et de collecter les points de données exploitables que d’enregistrer tous les éléments possibles. L’identification efficace de ces points de données nécessite un plan de base et des discussions créatives avec les parties prenantes. |
| Mai 2022 | [Utilisation [!UICONTROL Report Builder] options de diffusion avancées pour Power BI](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/use-report-builder-advanced-delivery-options-for-power-bi.html?lang=en) | Vidéo | Découvrez comment configurer une planification avancée pour envoyer un classeur de Report Builder à Power BI. |
| Mai 2022 | [Planification d’une requête de Report Builder](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/schedule-a-report-builder-request.html?lang=en) | Vidéo | Découvrez comment configurer une planification de base pour un classeur de Report Builder. |
...
* **Experience Manager Sites as a Cloud Service**
   ...
   * Vous pouvez désormais définir les types de données de modèle de contenu comme [traduisible](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/content-fragments/content-fragments-models.html?lang=en#properties) à l’aide d’une case à cocher dans l’éditeur de modèles de contenu. En outre, les règles et configurations de traduction de Experience Manager sont automatiquement mises à jour.

   _Nouvelle fonctionnalité du canal de version préliminaire_

   * Publier des fragments d’expérience dans l’aperçu : pour prévisualiser les expériences finales que vos visiteurs peuvent voir, vous pouvez publier des fragments d’expérience autonomes sur le service d’aperçu as a Cloud Service Experience Manager.
...
* **Experience Manager as a Cloud Service Foundation**
   ...
   Le module externe Maven Build Analyzer du SDK as a Cloud Service Experience Manager détecte les problèmes dans un projet Maven, y compris les dépendances manquantes. Il permet aux développeurs d’identifier des problèmes au cours du développement local, bien avant leur déploiement dans les environnements cloud avec Cloud Manager.
...
* **Analyseur des bonnes pratiques**
   ...
   * Possibilité de détecter et de générer des rapports sur l’utilisation des API Asset Manager non prises en charge. Quatre API ne sont plus prises en charge dans Experience Manager as a Cloud Service. Les clients doivent s’assurer qu’ils n’utilisent plus ces API et qu’ils doivent utiliser la nouvelle méthode de chargement de ressources.
   * Possibilité de détecter l’utilisation de modèles de fragments de contenu. Les modèles de fragment de contenu ne sont plus pris en charge pour la création de fragments de contenu sur Experience Manager as a Cloud Service. Les clients doivent créer des modèles de fragment de contenu pour remplacer les modèles de fragment de contenu.
   * Possibilité de détecter des ressources avec plus de 100 descendants sous le noeud de métadonnées de la ressource dans le référentiel. Adobe recommande de supprimer les noeuds de métadonnées dont vous n’avez pas besoin afin d’améliorer les performances lors du chargement des dossiers composés de ces ressources.
   * Possibilité de détecter et de générer des rapports sur le type d’entrepôt de données utilisé.
   * Modèle mis à jour pour Experience Manager Form Portal.

### Communauté

* **Webinaire GEM Experience Manager enregistré**

   * [_Intégrer le framework AEM et CIF pour créer une expérience d’e-commerce riche et immersive_](https://adobe.ly/3jorz5r).

* Experience Manager as a Cloud Service [Mise à jour de la version 2022.4.0](https://adobe.ly/3LO0gOo).
...
| -----------| ---------- | ---------- | ---------- | ------|
| Mai 2022 | [AEM mise à jour de la version 2021.4.0 as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/2021/2021-4-0.html?lang=en) | Vidéo | Consultez l’équipe produit d’AEM et découvrez les fonctionnalités et les innovations de la dernière version d’Adobe Experience Manager. | AEM Asset Essentials, Sites, Screens, Forms et Cloud Foundation |
| Mai 2022 | [AEM Cloud 5](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-5/cloud5-introduction.html) | Vidéos | Obtenez toutes les informations utiles dont vous avez besoin sur AEM as a Cloud Service dans de courtes vidéos de 5 minutes ou moins. Commencez par la saison 1. | AEM CS |
| Mai 2022 | [Obtention d’un jeton de connexion pour les intégrations](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-5/cloud5-getting-login-token-integrations.html) | Vidéo | Un guide détaillé sur la manière d’obtenir un jeton de connexion pour les intégrations de Cloud Service et certains cas d’utilisation pour ce faire. | AEM CS |
| Mai 2022 | [Affichage de plusieurs documents PDF dans un carrousel](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/display-pdf-in-carousel.html?lang=en) | Vidéo | Découvrez le cas d’utilisation courant d’affichage de plusieurs documents de PDF à l’utilisateur avant l’envoi du formulaire. | AEM Forms |
| Mai 2022 | [Images sans AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/how-to/images.html) | Vidéo | Découvrez le développement d’une expérience AEM sans affichage riche et attrayante à l’aide d’images, etc. | AEM Headless |
| Mai 2022 | [Texte enrichi avec AEM sans affichage](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/how-to/localized-content.html) | Vidéo | Découvrez comment utiliser le champ de texte multiligne, un type de données de fragments de contenu qui permet aux auteurs de créer du contenu de texte enrichi. | AEM Headless |
...
| Mai 2022 | [Déploiement de votre code](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/deploy-code.html) | Vidéo | Découvrez comment déployer votre code vers Production à l’aide des pipelines Cloud Manager dans AEM as a Cloud Service. | AEM CS, Cloud Manager |
| Mai 2022 | [Désactiver l’exécution du workflow de post-traitement](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/asset-microservices-configure-and-use.html#disable-post-processing-workflow-execution) | Documentation | Découvrez comment créer un modèle de workflow vide dans la section Processus de démarrage automatique lorsque le post-traitement n’est pas nécessaire. | AEM CS |
| Mai 2022 | [Filigranes](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/advanced/watermarks.html?lang=en) | Vidéo | Les fonctionnalités d’application d’un filigrane as a Cloud Service AEM permettent aux rendus d’image personnalisés d’être mis en filigrane à l’aide de n’importe quelle image PNG. | AEM Assets |
...
En savoir plus sur [Guides du Experience Manager](https://www.adobe.com/fr/products/xml-documentation-for-experience-manager/features.html).
...
| Publication | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Mai 2022 | [Création de règles de décision](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/create-rules.html?lang=en) | Vidéo | Découvrez comment créer des règles de décision pour la gestion des décisions. Règles ou _règles de décision_ sont l’un des composants de base requis des offres personnalisées. |
| Mai 2022 | [Création d’emplacements](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/create-placements.html) | Vidéo | Découvrez comment créer des emplacements pour la gestion des décisions. Les emplacements sont l’un des composants de base des offres. Un emplacement représente la combinaison du type de contenu et du canal, par exemple une image dans un email ou du code HTML sur un site Web. |
| Mai 2022 | [Créer des décisions](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/create-decisions.html) | Vidéo | Découvrez comment créer des décisions pour la gestion des décisions. Une décision associe vos emplacements et vos collections en une seule entité, de sorte qu’une décision puisse être prise pour proposer l’offre la plus pertinente au client. |
| Mai 2022 | [Diffuser des offres avec l’API Decisions Hub](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/deliver-offers-with-the-decisions-api.html) | Vidéo | Découvrez comment diffuser des offres avec l’API Decisions Hub. |
| Mai 2022 | [Créer des offres de secours](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/create-fallback-offers.html) | Vidéo | Découvrez comment créer des offres de secours pour la gestion des décisions. Les offres de secours sont des offres par défaut qui s’affichent pour les clients qui ne remplissent les critères d’aucune de vos offres personnalisées. |
| Mai 2022 | [Créer des collections](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/create-collections.html?lang=en) | Vidéo | Découvrez comment créer des collections pour la gestion des décisions. Les collections sont utilisées pour gérer les offres dans des groupes logiques et sont nécessaires pour créer des activités de gestion de décision. |
...
| ------- | ----------- |
| [!UICONTROL Campagnes] | Les fonctionnalités bêta suivantes sont disponibles pour tous les annonceurs :<ul><li>([!DNL Microsoft® Advertising] ) Prise en charge de la synchronisation, de la visibilité en lecture seule et de la création de rapports (y compris les données d’affichage publicitaire) pour vos campagnes publicitaires natives existantes sur le [!DNL Microsoft® Audience Network], y compris [!DNL Microsoft® Audience Ads].</li><li>([!DNL Google Ads] et [!DNL Microsoft® Advertising] ) Possibilité d’importer vos [!DNL Google Ads] campagnes et structure de campagne vers [!DNL Microsoft® Advertising] de [!UICONTROL Rechercher] > [!UICONTROL Outils] > [!UICONTROL Importation des campagnes bêta].<br><br>Une fois que vous avez importé des campagnes, vous pouvez vérifier l’état de votre tâche d’importation, consulter les logs d’erreur et modifier, suspendre ou supprimer votre planning d’importation.</li></ul> |
| [!UICONTROL Campagnes]<br><br>[!UICONTROL Portfolios] | ([!DNL Microsoft® Advertising] (campagnes) Les stratégies d&#39;offres suivantes sont désormais disponibles pour tous les utilisateurs :<ul><li>[!UICONTROL Partage d’impression Target]: Vous pouvez configurer des campagnes avec cette stratégie et éventuellement définir un partage d’impression cible, une position de publicité cible et un coût maximum par clic. Attention : Cette option n’est pas encore prise en charge dans les portefeuilles hybrides et ne peut pas être ajoutée aux portefeuilles standard.</li><li>[!UICONTROL Maximiser les clics]: Vous pouvez configurer des campagnes à l’aide de cette stratégie et éventuellement définir un coût maximum cible par clic. Vous pouvez inclure des campagnes avec cette stratégie dans des portefeuilles standard ou hybrides. Pour utiliser cette stratégie dans un portfolio hybride, l&#39;objectif du portfolio ne doit inclure que [!DNL Adobe] propriétés (mesures) et vous devez activer le téléchargement des objectifs Advertising Cloud Search vers [!DNL Microsoft® Ads].</li></ul> |
| Intégration avec Adobe Analytics | (7 avril) Dans le flux de données envoyé par Advertising Cloud à [!DNL Analytics], données pour [!DNL Google Ads] les annonces de recherche dynamique ne sont disponibles qu’au niveau du groupe d’annonces à compter du 7 mai 2022. |
...
| Publication | Nom | Type | Description | Application |
| -----------| ---------- | ---------- | ---------- |---------- |
| Mai 2022 | [Accès au compte de partage](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/advanced-tasks-admins/share-account-access.html) | Vidéo | Découvrez comment configurer l’accès en lecture seule aux transactions dans le compte d’un autre utilisateur. | [!DNL Acrobat Sign] |
| Mai 2022 | [Gestion des modèles de document](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/edit-a-template.html?lang=en) | Vidéo | Découvrez comment modifier ou supprimer un modèle dans votre bibliothèque. | [!DNL Acrobat Sign] |
| Mai 2022 | [Créer votre premier flux dans Microsoft® Power Automate](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfservices/create-workflow-power-automate.html?lang=en) | Article | Découvrez comment créer votre premier flux dans Microsoft® Power Automate à l’aide du connecteur Adobe PDF Services. | Document Services |
| Mai 2022 | [Obtention des informations d’identification pour Microsoft® Power Automate](https://experienceleague.adobe.com/docs/document-services/tutorials/pdfservices/getting-credentials-power-automate.html?lang=en) | Article | Découvrez comment obtenir des informations d’identification pour commencer à utiliser ou à tester les services Adobe PDF. Selon que vous êtes un utilisateur expérimenté ou un client existant, ce tutoriel décrit les étapes appropriées pour obtenir des informations d’identification. | Document Services |
