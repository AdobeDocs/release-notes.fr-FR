...
Mise à jour : **mardi 25 août 2025**
...
| ------- | ------- |
| **Disponibilité générale de l’assistant virtuel** | <ul><li>L’**[!UICONTROL assistant virtuel]** permet aux clientes et clients Adobe Status sur le web ou les appareils mobiles de trouver des réponses et d’effectuer des actions rapides sans quitter la page d’accueil. Il s’agit d’un emplacement unique pour obtenir de l’aide et exécuter des tâches rapidement. </li><li>L’assistant virtuel est désormais disponible pour l’ensemble des clientes et clients Adobe Status. Il est accessible en se connectant à [status.adobe.com](https://status.adobe.com/fr) et en interagissant avec le widget **[!UICONTROL Demandez à votre assistant]**.</li></ul> |
| **Recherche d’identifiant d’événement** | <ul><li>Les clientes et clients peuvent désormais effectuer des recherches par identifiant d’événement sur les pages Produit et Cloud, ainsi que sur l’assistant virtuel.</li></ul> |
| **Mise à jour de la configuration des notifications Slack** | <ul><li>Il sera demandé aux clientes et clients de saisir les détails de leur canal Slack avant de pouvoir procéder à la configuration. Cette mise à jour garantit une configuration Slack fluide, avec leur canal Slack à portée de main.</li></ul> |
| **Correctifs et améliorations** | <ul><li>Notifications manquantes : les notifications relatives à la disponibilité des déclarations adressées aux clientes et clients ne leur ont pas été envoyées concernant les CSO précédentes.</li><li>Notifications manquantes : lorsque deux événements se sont produits en même temps, les communications par e-mail ont été manquantes.</li><li>Historique de 40 jours pour les opérations de maintenance : les opérations de maintenance ne comportaient pas d’événement historique en raison de l’ancienneté (plus de 40 jours) de certaines d’entre elles.</li><li>Bannière de page du cloud : la bannière n’a pas été mise à jour lorsque les filtres ont été modifiés sur la page du cloud.</li><li>Améliorations de l’interface d’utilisation : les messages liés aux instructions destinées aux clientes et clients sont mis à jour pour plus de clarté.</li></ul> |
...
* **Sources :** (version bêta) utilisez la source Didomi pour ingérer les données de gestion du consentement et des préférences de Didomi, ce qui permet de respecter les réglementations de confidentialité et les stratégies marketing basées sur le consentement.
...
|---------|----|----|-----------|
| Juillet 2025 | [Problèmes de respect de la casse lors de la création d’audiences dans l’interface d’utilisation d’Experience Platform](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27033) | Nouvel article | Découvrez les solutions au problème de respect de la casse des noms d’audience pour que *NAME_1* et *name_1* soient traités comme des audiences distinctes. |
...
| Juillet 2025 | [Adobe Experience Platform : [!UICONTROL les audiences semblables] ne sont pas synchronisées avec Google Ad Manager.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27041) | Nouvel article | Découvrez les solutions au problème lorsque vous tentez d’activer une [!UICONTROL Audience semblable] d’Adobe Experience Platform (AEP) vers Google Ad Manager (GAM) et que l’audience apparaît dans GAM, mais reste vide et ne fonctionne pas. |
| Juillet 2025 | [Le traitement UPS échoue en raison d’un enregistrement dont la taille dépasse les limites d’ingestion dans AEP.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27068) | Nouvel article | Découvrez les solutions au problème d’échec de l’ingestion par lots UPS dans Adobe Experience Platform (AEP) lorsque des enregistrements dépassent les limites de taille. |
...
| Publié | Nom | Type | Description |
|---------|--------|---------|---------|
| Juillet 2025 | [Rendus manquants dans le fichier ZIP de téléchargement de ressources dans AEM](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27140) | Nouvel article | Découvrez les solutions au problème suivant : lorsque vous téléchargez plusieurs ressources avec différents rendus depuis Adobe Experience Manager (AEM) Brand Portal, seul le fichier d’origine est inclus dans l’archive ZIP. |
| Juillet 2025 | [Impossible de charger des fichiers ZIP volumineux dans l’environnement de production AEM](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26981) | Nouvel article | Découvrez les solutions au problème lié à l’échec du chargement de fichiers ZIP volumineux de plus de 100 Mo en raison des restrictions WAF dans l’environnement de production Adobe Experience Manager (AEM) 6.5. |
| Juillet 2025 | [[!DNL DITA] Les références de carte ou de rubrique sont rompues en raison d’une propriété `fmPostProcessedAt` obsolète.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27220) | Nouvel article | Découvrez les solutions au problème lorsque les références de carte ou de rubrique [!DNL DITA] peuvent sembler endommagées et que les paramètres prédéfinis de sortie peuvent manquer dans l’interface d’utilisation, lors de l’utilisation d’Adobe Experience Manager as a Cloud Service (AEMaaCS) ou d’AEM 6.5 avec AEM Guides. |
| Juillet 2025 | [Échec du démarrage des localisateurs sur AEM Forms 6.5.23 avec JDK 8 ou JDK 11](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27089) | Nouvel article | Découvrez les solutions au problème lorsque les localisateurs ne parviennent pas à démarrer à l’aide du script `gfsh` après la mise à jour vers le pack de services 23 d’AEM Forms dans un environnement en cluster. |
| Juillet 2025 | [Fragments de contenu non inclus dans la licence AEM Assets](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26616) | Nouvel article | Découvrez les solutions au problème lorsque des fragments de contenu ne sont pas inclus dans la licence AEM Assets dans AEM as a Cloud Service (AEMaaCS). |
| Juillet 2025 | [Le site AEM affiche une *erreur inattendue* en raison de problèmes liés à l’API JS Use.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26787) | Nouvel article | Découvrez les solutions au problème lorsque votre site public AEM tombe en panne par intermittence avec un message *Erreur inattendue* en raison de problèmes dans les composants de l’API JavaScript Use. |
| Juillet 2025 | [Activation de la transformation des demandes pour les URL raccourcies sur l’instance de création AEM as a Cloud Service](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26917) | Nouvel article | Découvrez les solutions au problème en raison dusquel les URL raccourcies sur l’instance de création redirigent vers la page de démarrage par défaut (`/aem/start.html`) au lieu du contenu prévu dans AEMaaCS. |
| Juillet 2025 | [Commentaires limités dans la [!UICONTROL vue Assets] malgré l’accès en lecture](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26928) | Nouvel article | Découvrez comment la [!UICONTROL vue Assets] utilise un modèle d’autorisations simplifié qui diffère du modèle plus granulaire dans l’interface d’utilisation tactile d’AEMaaCS. |
| Juillet 2025 | [Les liens HTTPS sont incorrectement signalés comme rompus dans le [!UICONTROL vérificateur de lien] AEM.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27042) | Nouvel article | Découvrez les solutions au problème en raison duquel les liens HTTPS valides ajoutés à l’éditeur de texte enrichi (RTE) sont incorrectement signalés comme rompus par le [!UICONTROL vérificateur de lien] dans AEMaaCS. |
| Juillet 2025 | [Les sauts de ligne de l’éditeur de texte enrichi (RTE) ne sont pas conservés après la publication dans AEM.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27046) | Nouvel article | Découvrez les solutions au problème en raison duquel l’éditeur de texte enrichi (RTE) de l’éditeur universel supprime les sauts de ligne ajoutés à l’aide de la combinaison de touches *Maj+Entrée* lorsque le contenu est publié dans AEMaaCS. |
| Juillet 2025 | [L’éditeur universel d’AEM ne prend pas en charge la section `scopes` d’`importmap`.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27047) | Nouvel article | Découvrez les solutions au problème de suppression automatique de la section `scopes` de l’`importmap` définie dans le fichier `head.html` dans AEMaaCS - Sites avec l’éditeur universel. |
| Juillet 2025 | [Impossible de transférer un fichier CSV directement via SFTP dans AEMaaCS](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27048) | Nouvel article | Découvrez comment, pour des raisons de sécurité et en raison de l’architecture d’AEMaaCS, les transferts directs de fichiers CSV d’AEM vers un système tiers via le protocole SFTP (Secure File Transfer Protocol) à partir du runtime AEM ne sont pas pris en charge. |
| Juillet 2025 | [Échec de la création du pipeline à l’étape d’installation du contenu modifiable dans AEMaaCS](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27058) | Nouvel article | Découvrez les solutions au problème lorsque la création du pipeline échoue pendant l’étape d’installation du contenu modifiable en raison d’une erreur d’analyse XML dans AEMaaCS. |
| Juillet 2025 | [La modification d’un fragment de contenu échoue en raison de la redirection dans AEMaaCS.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27059) | Nouvel article | Découvrez les solutions au problème lorsque vous faites l’objet d’une redirection hors de l’interface d’édition prévue lorsque vous essayez de modifier un fragment de contenu via la nouvelle interface d’utilisation Fragment de contenu (CF) d’AEMaaCS – Assets. |
| Juillet 2025 | [Le modèle de fragment de contenu ne parvient pas à se charger avec de nombreuses propriétés dans AEMaaCS.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27060) | Nouvel article | Découvrez les solutions au problème lorsque l’éditeur ne parvient pas à afficher tous les champs si le modèle contient un grand nombre de propriétés dans AEMaaCS – Assets. |
| Juillet 2025 | [Les en-têtes de réponse de géolocalisation ne reflètent pas l’emplacement de l’adresse IP cliente dans AEMaaCS.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27100) | Nouvel article | Découvrez les solutions au problème lorsque les en-têtes de géolocalisation dans les réponses HTTP d’AEMaaCS ne reflètent pas l’emplacement réel du client. |
| Juillet 2025 | [En-tête `X-Frame-Options: SAMEORIGIN` dupliqué dans la réponse AEMaaCS](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27172) | Nouvel article | Découvrez les solutions au problème lorsque l’en-tête `X-Frame-Options: SAMEORIGIN` apparaît deux fois dans les réponses HTTP d’AEMaaCS – Sites. |
| Juillet 2025 | La configuration d’un référentiel [privé [!DNL GitLab]  échoue dans AEMaaCS Cloud Manager.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27182) | Nouvel article | Découvrez les solutions au problème qui se produit lors de la configuration d’un référentiel GitLab privé dans un pipeline Cloud Manager dans AEMaaCS – Assets, où une erreur indique que l’URL du référentiel ne peut pas être résolue. |
| Juillet 2025 | Erreur [*403 Accès interdit* pour les points d’entrée AEM GraphQL acheminés via Edge Delivery Service](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27036) | Nouvel article | Découvrez les solutions au problème qui se produit lors de l’exécution de demandes `POST` vers des points d’entrée GraphQL natifs dans AEM as a Cloud Service - Sites acheminés via Adobe Edge Delivery Service, ce qui entraîne une erreur *403 Accès interdit*. |
...
| Juillet 2025 | [Ne pas utiliser [!DNL Live Search] et [!DNL OpenSearch] en même temps dans Adobe Commerce sur les infrastructures cloud et sur site](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26926) | Nouveaux articles | Découvrez l’utilisation de [!DNL Live Search] et d’[!DNL OpenSearch] dans Adobe Commerce, ainsi que leurs limitations, le comportement d’indexation et le fonctionnement indépendant de chaque système. |
| Juillet 2025 | [Erreur de création de répertoire dans Adobe Commerce sur les infrastructures cloud](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27010) | Nouveaux articles | Découvrez les solutions au problème lié à l’erreur *Impossible de créer un répertoire* qui se produit dans Adobe Commerce sur les infrastructure cloud en raison d’un système de fichiers en lecture seule. |
...
| Juillet 2025 | [Ressources minifiées introuvables ou générées pendant la phase de création](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27065) | Nouveaux articles | Découvrez les solutions au problème lorsque les ressources minifiées renvoient une erreur *404* après le déploiement en raison de problèmes liés au système de fichiers ou d’une configuration incorrecte des fichiers `.magento.env.yaml` ou `config.php` dans Adobe Commerce Cloud. |
| Juillet 2025 | [Correctif de prise en charge de la méthode d’expédition USPS Ground Advantage pour AC-9182](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27117) | Nouveaux articles | Découvrez le correctif AC-9182 qui permet de résoudre le problème lié à la nouvelle méthode d’expédition [!DNL USPS Ground Advantage] dans Adobe Commerce 2.4.4 - 2.4.6-p2. |
| Juillet 2025 | [Adobe Commerce 2.4.3-p2 - correctif de sécurité 2.4.5 pour CVE-2022-35698](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27118) | Nouveaux articles | Découvrez les correctifs de sécurité réguliers 2.4.5-p1 et 2.4.4-p2 pour Adobe Commerce et Magento Open Source. |
| Juillet 2025 | [Adobe Commerce 2.4.4 : impossible de créer des factures partielles](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27120) | Nouveaux articles | Découvrez le correctif du problème empêchant les utilisateurs et les utilisatrices de créer des factures partielles lors de l’utilisation d’[!DNL Apple Pay] ou de [!DNL Google Pay] via Braintree comme modes de paiement. |
| Juillet 2025 | [La recherche avancée n’affiche pas les résultats les plus pertinents.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27121) | Nouveaux articles | Découvrez un correctif pour le problème connu d’Adobe Commerce, où la recherche avancée n’affiche pas les résultats les plus pertinents en premier. |
| Juillet 2025 | [Erreur Nombre maximal de cookies dépassé dans Adobe Commerce](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27130) | Nouveaux articles | Découvrez les correctifs pour résoudre l’erreur *Nombre maximal de cookies dépassé* dans Adobe Commerce. |
| Juillet 2025 | [[!DNL FedEx] Migration de l’intégration de la méthode d’expédition de SOAP à l’ [!DNL RESTful] API](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27131) | Nouveaux articles | Découvrez un correctif qui permet de résoudre les problèmes liés à la migration de l’intégration de la méthode d’expédition [!DNL FedEx] de SOAP vers l’API [!DNL RESTful] pour Adobe Commerce 2.4.4-p4 - 2.4.6-pX. |
...
| Juillet 2025 | [Résolution des problèmes de rotation des clés de chiffrement : CVE-2024-34102](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27134) | Nouveaux articles | Découvrez comment résoudre les problèmes de rotation des clés de chiffrement après le suivi des étapes décrites dans cet article sur CVE-2024-34102. |
...
| Juillet 2025 | [Packages rétrogradés après la mise à niveau de la version 2.4.4 vers la version 2.4.4-p1](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27137) | Nouveaux articles | Découvrez un correctif pour le problème qui se produit lorsque les commerces sur Adobe Commerce version 2.4.4 exécutent la commande `composer update`, puis que les packages (modules) répertoriés ci-dessous sont rétrogradés vers leurs versions antérieures qui ne sont pas compatibles avec la version 2.4.4 et ne sont censés être utilisés qu’avec la version 2.4.5 et les versions ultérieures. |
| Juillet 2025 | [Migration de l’intégration de la méthode d’expédition UPS de SOAP à l’API  [!DNL RESTful] ](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27146) | Nouveaux articles | Découvrez un correctif qui permet de résoudre les problèmes liés à la migration de l’intégration de la méthode d’expédition [!DNL United Parcel Service] (UPS) de SOAP vers l’API [!DNL RESTful] pour Adobe Commerce 2.4.4 - 2.4.6-pX. |
| Juillet 2025 | [Correctif du package de compatibilité Adobe Commerce 2.4.7-p4 [!DNL HIPAA] 1.2.0](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27147) | Nouveaux articles | Découvez un correctif qui permet d’ajouter la compatibilité du nouveau package [!DNL HIPAA] 1.2.0 avec Adobe Commerce sur les infrastructures cloud 2.4.7-p4. |
| Juillet 2025 | [Délai d’exécution plus long pour tous les points d’entrée web asynchrones en bloc après le correctif de sécurité APSB25-08](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27148) | Nouveaux articles | Découvrez un correctif pour tous les points d’entrée web asynchrones en bloc, par exemple `POST rest/all/async/bulk/V1/products` avec plus de 1 000 entrées, qui présentent des délais d’exécution considérablement plus longs après l’application du correctif de sécurité APSB25-08. |
...
| Juillet 2025 | [Modifications rétroincompatibles pour l’API `placeOrder` GraphQL dans Adobe Commerce 2.4.6-p8](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27150) | Nouveaux articles | Découvrez un correctif pour le problème Cloud et sur site Adobe Commerce version 2.4.6-p8 connu où l’API `placeOrder` GraphQL ne renvoie pas une réponse d’erreur attendue, comme illustré dans les versions du correctif 2.4.6 précédentes. |
...
| Juillet 2025 | [Résolution des problèmes liés à des pannes de site Adobe Commerce](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27152) | Nouveaux articles | Découvrez comment résoudre les problèmes liés aux sites en panne dans Adobe Commerce. |
| Juillet 2025 | [Échec de la génération du contenu statique sur Adobe Commerce sur les infrastructures cloud](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27156) | Nouveaux articles | Découvrez les solutions au problème d’échec de génération du contenu statique lors du déploiement sur Adobe Commerce sur les infrastructures cloud. |
| Juillet 2025 | [Noms de groupe client, segments et informations sur les règles promotionnelles exposés via GraphQL](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27159) | Nouveaux articles | Découvrez un correctif pour empêcher l’exposition des noms de groupe de clients, des segments et des règles promotionnelles via GraphQL. |
| Juillet 2025 | [Erreur lors du filtrage des commandes dans Admin](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27163) | Nouveaux articles | Découvrez un correctif pour le problème Adobe Commerce où une erreur se produit lors de la tentative de filtrage des commandes dans Admin par date, affichant le message : *Violation de contrainte d’intégrité : 1052 Colonne « created_at » où la clause est ambiguë.* |
| Juillet 2025 | [E-mail de commande envoyé depuis l’adresse e-mail du serveur](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27164) | Nouveaux articles | Découvrez un correctif pour le problème connu d’Adobe Commerce sur les infrastructures cloud 2.2.4 lié aux e-mails de commande envoyés à partir de l’adresse e-mail du serveur. |
| Juillet 2025 | [Les utilisateurs et les utilisatrices ne peuvent pas ajouter de produits au panier si aucune option n’est sélectionnée dans **[!UICONTROL Autoriser les pays]**.](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27167) | Nouveaux articles | Découvrez un correctif pour le problème connu d’Adobe Commerce 2.4.4 avec PHP 8.1 où les utilisateurs et les utilisatrices ne peuvent pas ajouter de produits au panier si l’option **[!UICONTROL Autoriser les pays]** n’est pas sélectionnée. |
...
| Publié | Nom | Type | Description |
|---------|----|----|-----------|
| Juillet 2025 | [La diffusion échoue dans Adobe Campaign Classic v8.6.4 en raison de la  [!DNL Snowflake] limite de chaîne](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27132). | Nouvel article | Découvrez les solutions au problème d’échec des diffusions dans Adobe Campaign Classic v8.6.4 lors de l’étape `PrepareMessageImpl` en raison d’une erreur de limite de chaîne [!DNL Snowflake]. |
| Juillet 2025 | [Modification de la gestion des erreurs `rtEvent#PushEvents` dans Adobe Campaign V8](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27064) | Nouvel article | Découvrez les solutions au problème lorsque, dans Adobe Campaign V8, la méthode `rtEvent#PushEvents` ne renvoie plus d’erreur lors de la réception de payloads non valides, par exemple les valeurs hors plage du champ `wishedChannel`. |
...
| Publié | Applications | Nom | Type | Description |
| ----------| ---------- | ---------- | ---------- |---------- |
| Août 2025 | [!DNL Journey Optimizer] | [Suivre et générer des rapports sur les offres Journey Optimizer diffusées via la prise de décision AJO](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/reporting-on-ajo-od/introduction) | Tutoriels | Ce cas d’utilisation se concentre sur l’activation des rapports et de l’analyse des performances pour les offres diffusées via Adobe Journey Optimizer (AJO). |
| Août 2025 | [!DNL Journey Optimizer] | [Présentation du canal WhatsApp](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/channels/whatsapp/whatsapp-introduction) | Tutoriel vidéo | Obtenez une vue d’ensemble de l’intérêt qui existe à intégrer WhatsApp à Adobe Journey Optimizer. Elle souligne la portée globale de WhatsApp et ses avantages en termes d’engagement, et décrit les conditions préalables essentielles telles que la création d’un compte WhatsApp Business, la génération de jetons d’accès et la création de modèles de messages. |
...
| Août 2025 | [!DNL Journey Optimizer] | [Commencer avec WhatsApp dans Adobe Journey Optimizer](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/channels/whatsapp/get-started-with-whatsapp-in-ajo) | Tutoriel vidéo | Découvrez comment intégrer WhatsApp en tant que canal natif dans Adobe Journey Optimizer pour diffuser des messages sécurisés, personnalisés et en temps réel à grande échelle. |
| Août 2025 | [!DNL Journey Optimizer] | [Configurer le canal WhatsApp](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/whatsapp-channel/set-up-whatsapp-channel) | Tutoriel vidéo | Découvrez comment configurer le canal WhatsApp dans Adobe Journey Optimizer pour permettre la diffusion de messages professionnels en temps réel. |
| Août 2025 | [!DNL Journey Optimizer] | [Déverrouiller la réintégration du parcours avec des ID supplémentaires](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/create-journeys/unlock-journey-reentry-with-supplemental-id) | Tutoriel vidéo | Découvrez comment activer et appliquer un identifiant supplémentaire dans Adobe Journey Optimizer. |
| Août 2025 | [!DNL Journey Optimizer] | [Configurer des messages RCS dans Journey Optimizer](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/sms-mms-channel/set-up-rcs) | Tutoriel vidéo | Découvrez comment configurer et envoyer des messages RCS interactifs d’une marque dans Adobe Journey Optimizer à l’aide d’un fournisseur de SMS personnalisé. |
| Août 2025 | [!DNL Journey Optimizer] | [Utiliser l’optimisation des messages dans une campagne](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/create-campaigns/action-campaigns/leverage-message-optimization-in-a-campaign) | Tutoriel vidéo | Découvrez comment tirer parti de l’optimisation des messages dans les campagnes déclenchées par des actions ou des API. Vous découvrirez comment cibler des sous-audiences, créer des variations de messages en fonction de la localisation, activer un contenu de secours et mener plusieurs expériences au sein d’une même campagne. |
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Juillet 2025 | [*Erreur Vous n’avez pas l’autorisation de consulter cette épreuve* dans Workfront](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26973) | Nouvel article | Découvrez les solutions au problème lorsque le message d’erreur *Vous n’avez pas l’autorisation de consulter cette épreuve* s’affiche lorsque vous essayez d’accéder à une épreuve par le biais d’un e-mail [!UICONTROL Nouvelle épreuve] ou d’une URL directe. |
| Juillet 2025 | [Impossible de modifier le champ **Chemin** dans les demandes Adobe Workfront](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27160) | Nouvel article | Découvrez les solutions au problème en raison duquel le champ **Chemin** est verrouillé après l’envoi et ne peut pas être modifié. |
| Juillet 2025 | [Correction de l’erreur 500 de Workfront [!UICONTROL Fusion Watch Proofs] en production](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-27177) | Nouvel article | Découvrez les solutions au problème lorsque le module [!UICONTROL Fusion Watch Proofs] de Workfront affiche une erreur d’*échec d’exécution de l’appel rpc : [500]* en production, car la connexion ne dispose pas des droits d’administration. |
