...
| ----------| ---------- | ---------- | ---------- |---------- |
|April 2025| [!DNL Experience Platform] | [Evaluate batch audiences on demand](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/audiences/evaluate-audiences-on-demand)| New video | Evaluate batch audiences on demand with flexible audience evaluation. |
|April 2025| [!DNL Experience Platform] | [Migrate a mobile app from Target to Journey Optimizer](https://experienceleague.adobe.com/fr/docs/platform-learn/migrate-target-to-mobile-sdk-decisioning/overview)| New video | Learn how to migrate your mobile app implementation from the Adobe Target to the Adobe Journey Optimizer - Decisioning extension|
...
| Mai 2025 | [Qu’est-ce qu’Expert Success ?](https://experienceleague.adobe.com/fr/docs/commerce-learn/tutorials/webinars-and-events/commerce-conversations/what-is-expert-success) | Nouvelle vidéo | En savoir plus sur le success plan d’expert Adobe Commerce. En savoir plus sur les détails, y compris les trois canaux d’assistance et les cibles de niveau de service. |
| Mai 2025 | [Préparation technique des accélérateurs de succès](https://experienceleague.adobe.com/fr/docs/commerce-learn/tutorials/webinars-and-events/commerce-conversations/success-accelerators-technical-readiness) | Nouvelle vidéo | Découvrez Commerce Success Accelerator : préparation technique, révision de solution, planification d’événements et surveillance 24h/24 et 7j/7 pour des performances optimales. |
| Mai 2025 | [Adoption et activation des accélérateurs de succès](https://experienceleague.adobe.com/fr/docs/commerce-learn/tutorials/webinars-and-events/commerce-conversations/success-accelerators-adoption-and-enablement) | Nouvelle vidéo | Découvrez l’adoption et l’activation de l’accélérateur de succès Adobe Commerce pour le développement stratégique, l’amélioration des compétences et la gouvernance. |
| Mai 2025 | [Qu’est-ce qu’Ultimate Success ?](https://experienceleague.adobe.com/fr/docs/commerce-learn/tutorials/webinars-and-events/commerce-conversations/what-is-ultimate-success) | Nouvelle vidéo | Découvrez l’assistance proactive et les conseils stratégiques d’Adobe Commerce Ultimate Success pour des expériences digitales hautement performantes. |
...
| Avril 2025 | [Problème de performance lors de la mise à niveau du module `Magento_Company` après la mise à jour B2B 1.5.2](https://experienceleague.adobe.com/fr/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/magento-company-module-upgrade-performance-issue) | Nouveaux articles | Cet article fournit un correctif pour le problème de performances dans la mise à niveau du module `Magento_Company` après la mise à jour de la version 1.5.2 de B2B, en résolvant le temps de traitement trop long pour les jeux de données volumineux (environ 100 000 enregistrements ou plus) dans le tableau `company_structure`. |
...
| Avril 2025 | [*Le nombre maximal de cookies serait dépassé* erreur dans Adobe Commerce](https://experienceleague.adobe.com/fr/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/maximum-number-of-cookies-would-be-exceeded-error) | Nouveaux articles | Cet article fournit des correctifs pour résoudre l’erreur *Le nombre maximal de cookies serait dépassé* dans Adobe Commerce. |
| Avril 2025 | [[!DNL Web Application Firewall]  (WAF) affichant l’état désactivé dans Adobe Commerce sur l’infrastructure cloud [!UICONTROL interface Admin]](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26387) | Nouveaux articles | Découvrez la solution au problème lorsque l’[!DNL Web Application Firewall] (WAF) dans Adobe Commerce sur l’infrastructure cloud semble désactivée du côté [!UICONTROL Admin], bien qu’elle soit activée et fonctionne correctement. |
| Avril 2025 | [Résolution de l’échec de déploiement du cloud du correctif de sécurité Adobe Commerce](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26408) | Nouveaux articles | Découvrez la solution au problème d’échecs de déploiement provoqués par des configurations de cache principal non prises en charge dans Adobe Commerce sur l’infrastructure cloud. |
| Avril 2025 | [Résoudre les erreurs de mémoire tampon pleine dans Adobe Commerce sur l’infrastructure cloud](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26382) | Nouveaux articles | Découvrez la solution au problème de saturation d’un tampon du journal, qui entraîne la troncation des requêtes du journal d’accès lors des pannes du site. |
...
| Avril 2025 | [Résolution des problèmes d’accès  [!DNL Security Scan Tool]  résultats de l’analyse](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26357) | Nouveaux articles | Découvrez comment gérer une situation dans laquelle l’[!DNL Security Scan Tool] Adobe Commerce détecte des programmes malveillants ou des problèmes critiques, mais dont les résultats d’analyse sont inaccessibles. |
...
| Publié | Nom | Type | Description |
|---------|----|----|-----------|
| Avril 2025 | [Le marqueur d’URL de suivi remplace les URL appropriées dans Adobe Campaign](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26309) | Nouvel article | Découvrez la solution au problème des marqueurs d’URL de tracking dans Adobe Campaign. |
| Avril 2025 | [Libellé d&#39;export des énumérations non valable lors de l&#39;extraction du fichier](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26155) | Nouvel article | Découvrez la solution au problème d’exportation incorrecte des libellés d’énumération dans les workflows Adobe Campaign. |
...
| Avril 2025 | [Les profils quittent le parcours prématurément dans Adobe Journey Optimizer](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-26127) | Nouvel article | Découvrez la solution au problème de sortie inattendue des profils d’un parcours sans passer par un nœud désigné. |
...
* [Journey Optimizer B2B edition](https://experienceleague.adobe.com/fr/docs/journey-optimizer-b2b) (Toute aide autonome)
...
* [Présentations vidéo et tutoriels](https://experienceleague.adobe.com/fr/docs/journey-optimizer-b2b-learn/tutorials/overview) pour Journey Optimizer B2B edition
* [Description du produit et licences](https://helpx.adobe.com/fr/legal/product-descriptions/adobe-journey-optimizer-b2b.html#_blankl) pour Journey Optimizer B2B edition
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Mai 2025 | [Créer une vue chronologique](https://experienceleague.adobe.com/fr/docs/workfront-learn/tutorials-workfront/workfront-planning/create-and-manage-timeline-views) | Nouvelle vidéo | Découvrez comment gérer et personnaliser les vues de chronologie dans Workfront Planning. |
...
| Mai 2025 | [Présentation des composants de création de rapports](https://experienceleague.adobe.com/fr/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/reporting-components) | Nouvelle vidéo | Découvrez les composants de création de rapports pour affiner la visualisation des données avec des filtres basés sur des objets, des vues dynamiques, des regroupements structurés et une fonctionnalité de caractères génériques pour des informations personnalisées. |
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- |---------- |
| Avril 2025 | [Adobe Pass - nouvelle API REST v2](https://experienceleague.adobe.com/fr/docs/events/experience-league-recorded-events/solution/hidden/adobe-pass-rest-api-v2) | Nouvelle vidéo | Découvrez comment Adobe la nouvelle API REST v2 et son processus de migration. |
