...
Actualisation de la page suivante : **22 janvier 2025**
...
* [[!DNL Adobe Campaign]](#ac) (mise à jour du **21 janvier**)
...
* **[!DNL Workfront]** | _Réveil Avec Workfront : Demandez-Moi Quelque Chose_ | Au cours de cette session « Ask Me Anything », les conseillers d’affaires Adobe Workfront Samantha Miller, Aaron Baker et Mary Ann Erickson répondront aux questions en direct et partageront les bonnes pratiques de Workfront pour aider les clients à réussir en 2025. | **23 janvier à 11 h CET** | [S’inscrire](https://adobeevents.adobeconnect.com/eqfnatfznj47/event/registration.html?campaign-id=ExL)

* **[!DNL Workfront]** | _Connect : Workfront Collective_ | Rejoignez notre événement mensuel du lundi Workfront Collective conçu pour entrer en contact avec d’autres clients, discuter des fonctionnalités de Workfront, partager des idées et réfléchir ensemble à des solutions aux défis courants. | **27 janvier à 17 h CET** | [S’inscrire](https://events.teams.microsoft.com/event/7eabf155-b410-401e-8415-97306c28b9ca@fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL Workfront]** | _En savoir plus : comment surmonter la résistance au changement sur votre Parcours Workfront_ | Rejoignez nos experts en gestion du changement Workfront pour discuter des bonnes pratiques pour identifier et surmonter la résistance avec vos utilisateurs. | **30 janvier à 10 h CET** | [S’inscrire](https://events.teams.microsoft.com/event/ba4df540-2f36-427f-8893-978da4b26450@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
* **[!DNL Target]** | _Marketo et mochas : 5 fonctionnalités Marketo à connaître en 2025_ | Lors de notre première session Marketo &amp; Mochas de l’année, les experts Marketo Carly Gaver et Kate Colbert aborderont plus de 5 fonctionnalités riches en capacités qui peuvent améliorer l’expérience client et stimuler la demande en 2025. | **6 février à 11 h CET** | [S’inscrire](https://adobeevents.adobeconnect.com/ewh8dja8xr45/event/registration.html?campaign-id=ExL)

* **[!DNL Commerce]** | _Commerce et café : l’émergence du libre-service en B2B_ | Commencez l’année en force avec nos experts Commerce, Corey Gelato et Agbi Bajrushi, qui explorent les dernières tendances B2B et une approche pour tirer parti des nouvelles fonctionnalités d’Adobe Commerce afin de rester en tête de la concurrence toute l’année. | **13 février à 11 h CET** | [S’inscrire](https://adobeevents.adobeconnect.com/eezfyv5cqz0c/event/registration.html?campaign-id=ExL)
...
| Octobre 2024 | Échec du workflow [[!DNL mcSynch]  avec l’erreur `xtkfolder_fullname`**[!DNL duplicate key value violates unique constraint]](https://experienceleague.adobe.com/fr/docs/experience-cloud-kcs/kbarticles/ka-25094) | Nouvel article | Découvrez comment résoudre le problème d’échec du workflow `mcSynch_mcExec` [!DNL OOTB] avec une erreur. |
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Octobre 2024 | [Créer des politiques d’utilisation des données](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/data-governance-and-privacy/create-data-usage-policies) | Vidéo | Découvrez comment créer et gérer des politiques d’utilisation des données. Les politiques d’utilisation des données vous permettent de restreindre l’utilisation des données à des fins spécifiques en fonction des libellés des données. |
| Octobre 2024 | [Créer du contenu avec l’accélérateur de contenu de l’assistant IA](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/content-management/content-accelerator/create-content-using-the-ai-assistant-content-accelerator) | Vidéo | Découvrez comment utiliser l’accélérateur de contenu de l’Assistant IA pour générer des suggestions de variation de contenu proactives pour le texte et les images. |
| Octobre 2024 | [Classer les données à l’aide de libellés](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/data-governance-and-privacy/classify-data-using-lables) | Vidéo | Découvrez comment étiqueter vos schémas et vos jeux de données. Les libellés d’utilisation des données vous permettent de baliser et de classer les données en fonction des politiques de l’entreprise, des obligations contractuelles, des exigences de conformité et des réglementations locales dans Adobe Experience Platform. |
| Octobre 2024 | [Créer du contenu avec l’accélérateur de contenu de l’assistant IA](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/content-management/content-accelerator/create-content-using-the-ai-assistant-content-accelerator) | Vidéo | Découvrez comment utiliser l’accélérateur de contenu de l’Assistant IA pour générer des suggestions de variation de contenu proactives pour le texte et les images. |
| Octobre 2024 | [Expérimentation : vue d’ensemble](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/content-management/experimentation-overview) | Vidéo | Découvrez comment exécuter des tests et des simulations dans Journey Optimizer pour affiner votre contenu afin d’optimiser le parcours du client ou de la cliente en fonction de connaissances basées sur les données. |
| Octobre 2024 | [Accélérateur de contenu de l’Assistant IA : vue d’ensemble](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/content-management/content-accelerator/ai-assistant-content-accelerator-overview) | Vidéo | Découvrez comment l’accélérateur de contenu de l’Assistant IA peut aider les spécialistes du marketing en leur suggérant de façon proactive des variations de contenu pour le texte et les images. |
| Octobre 2024 | [Mesure et création de rapports : vue d’ensemble](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/report-and-monitor/measurement-and-reporting-overview) | Vidéo | Découvrez la création de rapports dans Journey Optimizer. |
| Octobre 2024 | [Éditeur de personnalisation : vue d’ensemble](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/personalize-content/personalization-editor-overview) | Vidéo | Identifiez le contenu qui peut être personnalisé dans Journey Optimizer. |
| Octobre 2024 | [Appliquer les politiques d’utilisation des données aux canaux Journey Optimizer](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/data-governance-and-privacy/enforce-data-usage-policies-in-journey-optimizer-channels) | Vidéo | Découvrez comment les politiques d’utilisation des données sont appliquées dans les canaux Journey Optimizer. |
...
| Octobre 2024 | [Créer des cartes de contenu](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/channels/content-cards/create-content-cards) | Vidéo | Découvrez comment créer des cartes de contenu pour votre application. |
| Octobre 2024 | [Notifications push : vue d’ensemble](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/channels/push-channel/push-notifications-overview) | Vidéo | Découvrez comment créer des notifications push pour impliquer à tout moment les utilisateurs et utilisatrices d’applications mobiles avec des messages ciblés personnalisés. |
| Octobre 2024 | [SMS/MMS : vue d’ensemble](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/channels/sms-channel/sms-mms-messages-overview) | Vidéo | Découvrez comment créer, planifier et distribuer des SMS et des MMS pour atteindre facilement votre clientèle en déplacement. |
| Octobre 2024 | [Création de messages : vue d’ensemble](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/content-management/message-authoring-overview) | Vidéo | Découvrez les options de création d’e-mail dans Journey Optimizer. |
| Octobre 2024 | [Profils et audiences : vue d’ensemble](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/profiles-audiences-subscriptions/profiles-and-audiences-overview) | Vidéo | Découvrez les audiences et profils clientèle unifiés dans Journey Optimizer. |
| Octobre 2024 | [Vue d’ensemble du cadre de gouvernance des données](https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/data-governance-and-privacy/data-governance-framework) | Vidéo | Comprendre le cadre de gouvernance des données dans Adobe Experience Platform. |
...
| Publié | Application | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |---------- |
| Septembre 2024 | Acrobat | [Comment convertir une personne vers un rôle d’administration](https://experienceleague.adobe.com/fr/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/promote-admin) | Vidéo | Découvrez comment promouvoir une personne vers un rôle d’administration Acrobat Sign à l’aide d’Adobe Admin Console. |
...
| Septembre 2024 | Acrobat Sign | [Outil de téléchargement en masse](https://experienceleague.adobe.com/fr/docs/document-cloud-learn/sign-learning-hub/admin-set-up/advanced-tasks-admins/bulk-download-tool) | Vidéo | Découvrez comment utiliser l’outil de téléchargement en masse pour télécharger tous les contrats que vous avez signés afin de gagner un temps précieux. L’outil de téléchargement en masse est disponible pour Windows et Mac OS X. |
