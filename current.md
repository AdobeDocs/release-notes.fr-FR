...
* **WORKFRONT** | Atelier client | _Admin 101 : Obtention de données Workfront_ | Vous découvrez Workfront ? Rejoignez nos réunions mensuelles &quot;New Admin&quot; pour poser des questions, obtenir des ressources et des recommandations, rencontrer d’autres nouveaux administrateurs et, pour cette session, découvrir les bonnes pratiques pour tout ce qui concerne le reporting dans Workfront. | **13 mars à 8 h PT** | [Enregistrer](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,POtiORmhEE2cwlhRFM2JMw,dUgy5MAHzkeSpm357qe4Ww,lKFY7SPny0-i8YfbN5Ow3g?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **EXPERIENCE MANAGER** | AEM GEMS | _Prise en main de la création AEM et des Edge Delivery Services_ | Rejoignez AEM webinaire GEM pour commencer à créer AEM avec des Edge Delivery Services. Découvrez comment créer un développement de projet AEM activé avec la création WYSIWYG à l’aide d’AEM Cloud Service. | **13 mars à 9 h PT** | [Enregistrer](https://aem-augs.adobe.com/events/details/adobe-experience-manager-aem-learning-chapter-presents-getting-started-with-aem-authoring-and-edge-delivery-services/)

* **EXPERIENCE MANAGER** | Webinaire | _Expressos et Experience Manager : raisons pour lesquelles AEM est plus puissant en mode cloud_ | Rejoignez les expertes et experts Adobe qui discutent de la manière d’assurer une transition fluide vers le cloud par le biais de l’évaluation du contenu et de la planification de la migration à l’aide d’outils tels que Best Practice Analyzer et Cloud Acceleration Manager. | **14 mars à 13 h 00 ET** | [S’inscrire](https://adobeevents.adobeconnect.com/e8jc5prppkfr/event/registration.html?campaign-id=ExL)
...
* **ANALYTICS** | Les créateurs d&#39;expérience : échange de compétences | _Échange de compétences en Adobe Summit pour Adobe Analytics_ | Le 28 mars 2024, nous accueillerons le Adobe Analytics Skill Exchange au Sommet de Las Vegas ! Inscrivez-vous dès maintenant pour obtenir des conseils, des astuces et des bonnes pratiques auprès des clients et des champions d’Analytics. | **28 mars à 9 h PT** | [Enregistrer](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=952%20953)

* **EXPERIENCE MANAGER** | Les créateurs d&#39;expérience : échange de compétences | _Échange de compétences à l&#39;Adobe Summit pour AEM_ | Le 28 mars 2024, nous accueillerons le Sommet AEM Skill Exchange à Las Vegas ! Inscrivez-vous dès maintenant pour obtenir des conseils, des astuces et des bonnes pratiques auprès des clients et des champions d’AEM. | **28 mars à 9 h PT** | [Enregistrer](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=950%20951)

* **EXPERIENCE MANAGER** | Les créateurs d&#39;expérience : échange de compétences | _Échange de compétences à l&#39;Adobe Summit pour les Marketo Engage_ | Le 28 mars 2024, nous organiserons un échange de compétences Marketo Engage au Sommet de Las Vegas ! Inscrivez-vous dès maintenant pour obtenir des conseils, des astuces et des bonnes pratiques auprès des clients et des champions Marketo Engage. | **28 mars à 9 h PT** | [Enregistrer](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=954%20955)

* **WORKFRONT** | Les créateurs d&#39;expérience : échange de compétences | _Échange de compétences dans un Adobe Summit pour Workfront_ | Le 28 mars 2024, nous accueillerons le Adobe Workfront Skill Exchange au Sommet de Las Vegas ! Inscrivez-vous dès maintenant pour obtenir des conseils, astuces et bonnes pratiques auprès des clients Workfront. | **28 mars à 9 h PT** | [Enregistrer](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=956%20957)

* **WORKFRONT** | Événement de la communauté | _Connect : conversation avec l’administration pour les personnes spécialisées dans le marketing et la création de contenu_ | Êtes-vous administrateur ou administratrice système pour une équipe marketing ou créative ? Cette session orientée clientèle vous connecte à d’autres administrateurs et administratrices pour discuter des bonnes pratiques et des conseils et astuces. | **5 avril à 9h00 PT** | [Enregistrer](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,S3qiBpspOUyiG7Vl_PtPXg,rFPUK2gma0OCogFhuCyzjw,nTcEntnvgkePuH01JzrsQw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
## ![Icône](/assets/experience-league.png) Adobe de la chaîne d’approvisionnement de contenu {#content-supply-chain}

En savoir plus [Chaîne d’approvisionnement de contenu](https://business.adobe.com/solutions/adobe-genstudio.html), Adobe dispose d’une solution de bout en bout pour accélérer et simplifier votre contenu grâce à l’intelligence artificielle générative et à l’automatisation intelligente.

+++Détails

| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Février 2024 | [Tutorials de la chaîne d’approvisionnement de contenu](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html) | Vidéos | Affichez les tutoriels sur la chaîne d’approvisionnement de contenu dans Experience League. La chaîne d’approvisionnement de contenu est une solution de bout en bout de l’Adobe qui accélère et simplifie votre chaîne d’approvisionnement de contenu grâce à l’IA générative et à l’automatisation intelligente. |
...
* [mercredi 30 janvier 2024](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2024/02142024.html#status)
...
**Autorisations des Experience Platform**
...
* Les informations sur l’appartenance à un groupe d’utilisateurs sont désormais disponibles pour chaque rôle lors de l’affichage de la liste des rôles d’un utilisateur dans l’onglet rôles . La variable **[!UICONTROL Supprimer le rôle]** est désactivée pour les utilisateurs auxquels un rôle a été affecté via un groupe d’utilisateurs uniquement.
...
| Publié | Nom | Type | Description |
|---------|----|----|-----------|
| Février 2024 | [[!UICONTROL Ingestion des valeurs par défaut] in [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23641.html) | Nouvel article | Découvrez comment définir une valeur par défaut lors de l’ingestion dans [!DNL Adobe Experience Platform (AEP)], en particulier pour [!DNL upsert] , vous devez utiliser des mappages explicites dans votre processus d’ingestion de données. |
...
[!DNL Analytics] date de publication : **13 mars 2024**
...
Vidéos, tutoriels ou cours nouveaux ou mis à jour pour Adobe Analytics.

| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Février 2024 | [Création d’éléments de données dans des balises Experience Platform pour la mise en oeuvre d’Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-data-elements-in-tags-for-the-analytics-implementation.html) | Vidéo | Créez des éléments de données pour votre [!DNL Analytics] implémentation dans des balises basées sur les variables et les événements documentés dans un document de référence de conception de solution (SDR). |
| Février 2024 | [Créer une règle de page globale dans les balises Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-a-global-page-rule-in-tags.html) | Vidéo | Découvrez comment configurer une règle de page globale pour les points de données à envoyer à Adobe Analytics sur chaque page à l’aide de balises Experience Platform. |
| Février 2024 | [Validation de la règle de chargement de page globale dans les balises Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/validating-your-global-page-load-rule-in-tags.html) | Vidéo | Découvrez comment valider votre règle de chargement de page globale avec le débogueur Experience Platform. |
| Février 2024 | [Création de règles de balises Experience Platform pour les événements de succès](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-success-events.html?lang=en) | Vidéo | Découvrez comment utiliser des règles dans des balises pour effectuer le suivi des événements de conversion (événements de succès) sur votre site. |
| Février 2024 | [Utiliser des doPlugins et des plug-ins d’implémentation dans les balises Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/use-doplugins-and-implementation-plugins.html?lang=fr) | Vidéo | Découvrez les avantages des doPlugins et ajoutez des plug-ins d’implémentation Analytics pour enrichir la collecte de données. |
| Février 2024 | [Définition de filtres d’URL internes](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/set-internal-url-filters.html?lang=en) | Vidéo | découvrez les paramètres concernant les référents, en les définissant comme référents internes (pour alimenter les rapports de cheminement) ou référents externes (pour alimenter les rapports de domaine référent/référent). |
| Février 2024 | [Balises : votre assistant personnel](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/analytics/analysis-workspace/tips-and-tricks/tags-your-personal-assistant.html) | Article | Découvrez comment les balises Experience Platform peuvent rationaliser vos analyses numériques, en tant qu’assistant personnel pour trouver efficacement ce dont vous avez besoin. Jeff Bloomer, champion d’Adobe Analytics, partage des idées d’experts sur la maximisation du potentiel de cet outil pour votre bénéfice. |
...
| Publié | Nom | Type | Description |
|---------|----|----|-----------|
| Février 2024 | [Modifications générées par le lien du projet (URL) lorsque vous partagez un espace de travail Adobe Analytics](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21698.html) | Nouvel article | Cet article offre une solution au problème Adobe Analytics où un lien de projet change chaque fois qu’un lien de projet d’espace de travail est récupéré dans un espace de travail Adobe Analytics partagé. Vous pouvez utiliser le lien nouvellement généré ou le lien précédemment généré pour accéder au projet cible. |
...
[!DNL Customer Journey Analytics] date de publication : **13 mars 2024**
...
* Cloud Manager valide désormais les dates d’expiration non seulement pour le [certificat](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html?lang=fr) principal, mais également pour les certificats intermédiaires.
...
| Février 2024 | Experience Manager Sites | [Configurer la création de documents](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/set-up.html) | Vidéo | Guide sur la configuration de la création de documents pour les auteurs et les autrices. |
| Février 2024 | Experience Manager Sites | [Workflows de documents](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html) | Vidéo | Découvrez comment utiliser des workflows de document avec la création de documents AEM. |
| Février 2024 | Experience Manager Sites | [Versions de document](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | Vidéo | Découvrez comment contrôler les versions des documents créés à l’aide de la création de documents AEM. |
| Février 2024 | AEM CS | [Cloud 5 - Recherche tierce](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-3rd-party-search.html) | Vidéo | Découvrez comment la recherche tierce peut être mieux intégrée aux Edge Delivery Services. |
| Février 2024 | Experience Manager Assets | [Événements AEM Assets pour l’intégration PIM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/assets-pim-integration.html) | Vidéo | Découvrez comment intégrer AEM Assets à un système tiers, tel qu’un système de gestion des informations sur les produits (PIM) ou de gestion des lignes de produits (PLM), pour mettre à jour les métadonnées des ressources à l’aide d’événements d’AEM E/S natifs. |
| Février 2024 | AEM Headless | [Champs personnalisés](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | Vidéo | Découvrez comment créer des champs personnalisés dans l’éditeur de fragments de contenu AEM. |
| Février 2024 | Experience Manager, AEM Cloud Manager, Marketo Engage | [AEM conseils et astuces concernant les champions - Utilisation des journaux dans Cloud Manager](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/cloud-manager-using-logs.html) | Vidéo | Regardez ces conseils de votre compatriote AEM, Rami EL Gamal. Dans cette vidéo, Rami vous explique comment télécharger des journaux dans Cloud Manager, tout en partageant des conseils sur les bonnes pratiques. |
| Février 2024 | AEM CS | [Cloud 5 - Surveillance des utilisateurs réels (RUM)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-rum.html?lang=en) | Vidéo | Explorez les analyses de surveillance des utilisateurs réels (RUM) qui Adobe les offres sur ses sites d’AEM fournis avec des Edge Delivery Services et comment RUM peut être utilisé pour améliorer un site web. |
| Février 2024 | Experience Manager Forms | [Générer un PDF avec les données de l’envoi de formulaire basé sur les composants principaux](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/generate-pdf-from-core-component-form-submission.html) | Vidéo | Fusionner les données de l’envoi de formulaire basé sur des composants principaux avec le modèle XDP dans le workflow. |
| Février 2024 | AEM Cloud Manager | [AEM champion des bonnes pratiques et des conseils - Préparation et planification d’une migration vers AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | Vidéo | Explorez les conseils d’experts et les bonnes pratiques de votre compatriote AEM, Wilson Faure. Dans cette vidéo, il navigue dans les complexités de la planification et de la préparation de la migration vers AEM as a Cloud Service. |
| Février 2024 | Experience Manager Sites | [Cloud 5 - Travailleurs Edge](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=en) | Vidéo | Découvrez l’importance des outils de pointe dans AEM Sites et les Edge Delivery Services et comment les intégrer à vos systèmes principaux. |
...
| Publié | Nom | Type | Description |
|---------|--------|---------|---------|
| Février 2024 | [[!DNL CDN] modèle dans [!UICONTROL Configuration de l’application] n’enregistre pas](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html) | Nouvel article | En savoir plus sur la solution lorsque la variable [!DNL CDN] modèle dans [!UICONTROL Configuration de l’application] ne peuvent pas être enregistrées. |
| Février 2024 | [Causes JDK 11 `NoClassDefFoundError` [!DNL AEM] 6,5](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23581.html) | Nouvel article | En savoir plus sur l’installation du [!DNL CXF] des modules externes pour résoudre le problème de la variable `NoClassDefFoundError` après une mise à niveau vers [!DNL Java™] 11 avec [!DNL AEM] 6.5x. |
| Février 2024 | [Comment qualifier une [!DNL AEM as Cloud Service] ticket d’assistance](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23750.html) | Nouvel article | Découvrez comment qualifier entièrement un ticket pour que l’assistance puisse traiter et comprendre rapidement le problème, ainsi que les informations requises. |
| Février 2024 | [Découvrez comment modifier le serveur et [!DNL JVM] fuseau horaire pour l’Europe/Paris dans [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | Nouvel article | Découvrez comment modifier le serveur et [!DNL JVM] fuseau horaire pour l’Europe/Paris dans [!DNL AEM as a Cloud Service]. |
| Février 2024 | [Les workflows sont définis sur &quot;non modifiables&quot; après le déploiement du code.](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | Nouvel article | Découvrez comment résoudre le problème [!DNL AEM] problème après la création d’un workflow dans [!DNL AEM] suivie d’un déploiement de code, la variable [!UICONTROL Workflow] apparaît comme &quot;Non modifiable&quot;. Pour respecter les bonnes pratiques, vous devez [!UICONTROL Workflow] modèles dans le code base cohérents entre plusieurs environnements, afin que vous n’ayez pas à recréer [!UICONTROL Workflows] pour chaque environnement. |
| Février 2024 | [[!DNL DDoS] attaque ou surcharge de robots [!DNL AEM] avec trafic](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23718.html) | Nouvel article | Découvrez comment déboguer ce problème en activant la journalisation au niveau de Dispatcher et prenez des mesures pour améliorer la mise en cache de Dispatcher, ce qui permet d’éviter les pics de trafic. |
| Février 2024 | [Problèmes courants liés à l’ingestion des ressources et solutions](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23717.html) | Nouvel article | En savoir plus sur les [!DNL AEM] Scénarios de problème d’ingestion des ressources et comment les analyser, y compris le traitement élevé, le volume élevé, le volume élevé [!DNL DAM] référentiels et de nombreux auteurs simultanés. |
| Février 2024 | [Limite maximale des variations, des performances et de la politique de conservation des données de [!UICONTROL Fragments de contenu]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23715.html) | Nouvel article | Découvrez la limite maximale du nombre de variations autorisées dans une seule [!UICONTROL fragment de contenu], si plusieurs variations contribuent à la lenteur du site et s’il existe une politique de rétention pour les éléments supprimés [!UICONTROL fragments de contenu]. |
| Février 2024 | [[!UICONTROL Demande de suppression] workflow déclenché lors de la suppression du contenu](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23690.html) | Nouvel article | Découvrez quand un utilisateur se connecte et supprime une page ou une ressource dans [!DNL AEM], le &quot;[!UICONTROL Demande de suppression]&quot; est déclenché. |
| Février 2024 | [[!DNL HTML] fichier stocké dans [!DNL CRX] ne s’ouvre pas dans le navigateur, est téléchargé à la place.](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23689.html) | Nouvel article | A [!DNL HTML] stocké directement dans le fichier [!DNL Oak] ne s’ouvre pas dans le navigateur. Il est téléchargé dans [!DNL AEM 6.1 SP2] et versions ultérieures. |
| Février 2024 | [[!DNL Adobe Experience Manager]: `WARN` message de `Scheduler job requested thread pool with name org-apache-sling-sitemap`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23665.html) | Nouvel article | En savoir plus sur le problème lors de la [!DNL AEM 6.5] démarrage, `WARN` les messages apparaissent plusieurs fois dans la variable `error.log`. |
| Février 2024 | [[!DNL Adobe Experience Manager]: noeud avec `sling:resourceType=wcm/msm/components/ghost`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23664.html) | Nouvel article | Découvrez le problème lorsque, dans certains cas, des noeuds avec une `sling:resourceType` valeur de `wcm/msm/components/ghost` existent. Cet article explique comment le noeud est créé. |
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Février 2024 | [Connexion et exécution de requêtes sur la base de données Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/remote-db-connection-execute-queries.html?lang=en) | Vidéo | Découvrez comment vous connecter à un projet Adobe Commerce on-cloud, vider une base de données pour l’utiliser hors site, masquer les informations d’identification personnelles et la supprimer. |
| Février 2024 | [Intégration technique de Commerce Cloud et transfert matériel - Chronologie du processus de lancement](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-commerce-cloud/technical-onboarding-hardware-handoff/launch-process-timeline.html) | Vidéo | Découvrez l’intégration technique de Adobe Commerce Cloud pour la chronologie du processus de lancement. |
...
| Publié | Nom | Type | Description |
|---------|--------|---------|---------|
| Février 2024 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html?lang=fr) | Nouveaux articles | Nouveaux articles sur l&#39;application de correctifs disponibles dans [!DNL QPT] 1.1.4, [!DNL QPT] 1.1.45 et [!DNL QPT] 1.1.46 ont été publiés et se trouvent dans leurs sections respectives. |
| Février 2024 | [Plusieurs lignes dans la base de données pour la même entité](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/database/multiple-rows-in-database-for-same-entity.html) | Nouveaux articles | Cet article fournit une solution au problème où il existe plusieurs lignes pour le même ID d’entité dans la base de données. |
| Février 2024 | [Recommendations [!DNL JS] erreurs après la mise à niveau vers Adobe Commerce version 2.4.5](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/recommendations-js-errors-after-upgrade-to-adobe-commerce-version-2-4-5.html) | Nouveaux articles | Cet article fournit un correctif pour le cas où, après la mise à niveau vers Adobe Commerce (toutes les méthodes de déploiement), il existe des [!DNL JS] erreurs dans la console liées aux modules/unités Recommendations du produit. |
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Février 2024 | Interface utilisateur web de Campaign, Experience Platform | [Créer une audience avec un Experience Platform](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/profiles-and-audiences/create-an-audience-with-experience-platform.html) | Vidéo | Découvrez comment créer une destination pour utiliser une audience Experience Platform dans Adobe Campaign. |
| Février 2024 | Interface utilisateur web de Campaign | [Exploration de l’interface utilisateur Web de Campaign](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/getting-started/explore-the-web-ui.html) | Vidéo | Découvrez comment accéder à l’interface utilisateur web de Campaign et y naviguer, et comment personnaliser les listes de stock. Découvrez l’assistant de connaissances optimisé par l’IA. |
| Février 2024 | Interface utilisateur web de Campaign | [Concevoir entièrement le contenu d&#39;un email](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/messages-and-deliveries/create-email-content-from-scratch.html) | Vidéo | Découvrez comment naviguer dans le Concepteur d’e-mail. Découvrez comment structurer et concevoir entièrement un e-mail, et personnaliser et tester votre e-mail. |
| Février 2024 | Interface utilisateur web de Campaign | [Gestion et création d’audiences](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/profiles-and-audiences/manage-and-build-audiences.html) | Vidéo | Découvrez comment créer et gérer des audiences, comment sélectionner des audiences pour une diffusion et définir des populations témoins. |
| Février 2024 | Interface utilisateur web de Campaign | [Création d’un workflow de ciblage](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/workflows/create-a-targeting-workflow.html) | Vidéo | Découvrez le fonctionnement des workflows et comment créer un workflow de ciblage. |
| Février 2024 | Interface utilisateur web de Campaign | [Création d’une diffusion par e-mail](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/messages-and-deliveries/create-an-email-delivery.html) | Vidéo | Découvrez comment créer entièrement une diffusion par e-mail, définir l’audience, concevoir le contenu, simuler l’aperçu et envoyer un BAT. |
| Février 2024 | Interface utilisateur web de Campaign, Experience Platform | [Créer une audience avec un Experience Platform](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/profiles-and-audiences/create-an-audience-with-experience-platform.html) | Vidéo | Découvrez comment créer une destination pour utiliser une audience Experience Platform dans Adobe Campaign. |
| Février 2024 | Interface utilisateur web de Campaign | [Créer un email en téléchargeant le HTML](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/messages-and-deliveries/create-an-email-by-uploading-html.html) | Vidéo | Découvrez comment créer un e-mail en chargeant un fichier HTML, comment le rendre compatible avec le concepteur d’e-mail et comment le convertir en modèle. |
| Février 2024 | Interface utilisateur web de Campaign | [Désabonner Dos et Don&#39;t](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/additional-resources/unsubscribe-dos-and-do-nots.html) | Article | Utilisez une liste des actions à effectuer et des actions à éviter lors de la gestion des désabonnements. |
...
| Publié | Nom | Type | Description |
|---------|----|----|-----------|
| Février 2024 | [Impossible d’afficher correctement la fenêtre des modèles de diffusion lorsqu’elle est connectée à [!DNL Campaign Console] via [!DNL VPN]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | Nouvel article | En savoir plus sur la solution du problème lorsque vous vous connectez à [!DNL Adobe Campaign Console] via [!DNL VPN], vous ne pouvez pas voir les données des modèles de diffusion dans la fenêtre. |
...
| Publié | Nom | Type | Description |
| -----------| ---------- | ---------- | ---------- |
| Février 2024 | [Double opt-in pour Sinch et Infobip](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/sms-channel/sms-double-opt-in.html?lang=fr) | Vidéo | Découvrez comment configurer le double opt-in pour les SMS. |
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Février 2024 | [!DNL Adobe Firefly] | [Découvrir l’Adobe Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html?lang=en) | Vidéo | Découvrez l&#39;Adobe Firefly de l&#39;avenir de la créativité avec l&#39;IA générative, conçue pour l&#39;utilisation et l&#39;innovation de la sécurité commerciale. |
| Février 2024 | [!DNL Adobe Firefly] | [Page de destination](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/landing-page.html?lang=en) | Vidéo | Découvrez comment commencer à utiliser Adobe Firefly. |
| Février 2024 | [!DNL Adobe Firefly] | [Remplissage générateur](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html?lang=en) | Vidéo | Découvrez comment utiliser le remplissage générique pour ajouter, développer ou supprimer du contenu de vos images de manière non destructive à l’aide de simples invites de texte. Le remplissage générateur vous permet d&#39;améliorer votre créativité et de créer des projets extraordinaires. |
| Février 2024 | [!DNL Adobe Firefly] | [Recolor générique](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html?lang=en) | Vidéo | Découvrez comment prévisualiser instantanément différentes variations de couleur pour le conditionnement, les affiches ou les illustrations de votre produit sur des fichiers vectoriels. La fonction Recolor générique vous permet de redéfinir la couleur aussi rapidement que vous pouvez le saisir. Testez des idées originales, idéalisez différents thèmes ou palettes et produisez plusieurs variantes en un clin d’oeil. |
| Février 2024 | [!DNL Adobe Firefly] | [Exemples d’utilisation de Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/examples.html?lang=en) | Vidéo | Découvrez comment vous pouvez utiliser Firefly pour créer des présentations PowerPoint intéressantes, des panneaux d’humeur, des idées, des captures d’écran, etc. |
| Février 2024 | [!DNL Adobe Firefly] | [Effets de texte](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/text-effects.html?lang=en) | Vidéos | Découvrez comment créer un texte unique et inspirant pour vos projets à l’aide de simples invites de texte. Les effets de texte vous permettent d’améliorer votre créativité et de créer un texte extraordinaire pour vos projets. |
