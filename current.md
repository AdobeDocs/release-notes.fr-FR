...
| Juillet 2022 | [Utilisation de l’outil de correctif de qualité](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/tools/quality-patch-tool.html) | Type | En savoir plus sur les [!UICONTROL Outil Correctif de qualité], qui est un outil de ligne de commande qui fournit des correctifs de qualité pour Adobe Commerce et Magento Open Source. |
...
| Juillet 2022 | [Gérer l’état de la commande](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/orders/order-status.html) | Type | Découvrez comment vérifier l’état de la commande et ses détails, et comment modifier l’état d’une commande, si nécessaire. |
